...
dev-vllm: network-create ## تشغيل خادم vLLM - Start vLLM inference server (GPU required)
	...
	@echo "$(BLUE)API:$(RESET) http://localhost:$${VLLM_PORT:-8000}/v1"
	@echo "$(BLUE)Health:$(RESET) http://localhost:$${VLLM_PORT:-8000}/health"
	@echo "$(BLUE)Models:$(RESET) http://localhost:$${VLLM_PORT:-8000}/v1/models"
