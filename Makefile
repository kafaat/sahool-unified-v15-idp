...
status: ## عرض حالة الخدمات - Show service status
	...
	@echo "  $(BLUE)Field Management (Docker):$(RESET) http://localhost:3000"
	...
	@echo "  $(BLUE)Web Application:$(RESET)          http://localhost:3001 (PORT=3001 npm run dev)"
	@echo "  $(YELLOW)Note: Web app defaults to :3000 but conflicts with Docker field-management$(RESET)"
