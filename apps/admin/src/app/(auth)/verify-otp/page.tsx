      ...
      try {
        ...
        setTimeout(() => {
          if (purpose === 'password_reset') {
            ...
            router.push(
              `/reset-password?token=${token}&identifier=${encodeURIComponent(identifier)}`
            );
          } else {
        ...
        >
          {isVerified ? (
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">{t.successMessage}</p>
            ...
            <>
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">{t.verifySubtitle}</p>
