  ...
  return (
    <div className="min-h-full flex items-center justify-center p-6">
      <div className="max-w-lg w-full bg-white rounded-xl border-2 border-red-200 p-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">حدث خطأ في لوحة الإدارة</h1>
        <h2 className="text-lg text-gray-700 mb-4">Admin Dashboard Error</h2>
