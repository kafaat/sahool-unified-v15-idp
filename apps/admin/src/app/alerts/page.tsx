...
function generateMockWeather(): WeatherData[] {
  ...
  const conditions: Array<"sunny" | "cloudy" | "rainy" | "windy"> = [
    "sunny",
    "cloudy",
    "rainy",
    "windy",
  ...
  return governorates.map((gov) => ({
    ...
    forecast: Array.from({ length: 5 }, (_, i) => ({
      day: ["السبت", "الأحد", "الإثنين", "الثلاثاء", "الأربعاء"][i] ?? "السبت",
  ...
  const alerts: Alert[] = [
    {
      ...
      message:
        "درجات حرارة مرتفعة متوقعة خلال الأيام القادمة. يُنصح بزيادة الري.",
      governorate: "صنعاء",
    ...
    },
    {
      ...
      message:
        "تم رصد حالات إصابة باللفحة المتأخرة في منطقة تعز. فحص المزارع فوراً.",
      governorate: "تعز",
...
export default function AlertsPage() {
  ...
  const filteredAlerts =
    alertFilter === "unread" ? alerts.filter((a) => !a.isRead) : alerts;
          ...
          {selectedWeather && (
            <div className="bg-gradient-to-br from-sahool-500 to-sahool-700 rounded-2xl p-6 text-white">
              ...
              <div className="mt-6 pt-6 border-t border-white/20">
                <p className="text-sm text-sahool-100 mb-3">
                ...
                <div className="grid grid-cols-5 gap-2">
                  {selectedWeather.forecast.map((day, i) => {
                    const DayIcon =
                      WEATHER_ICONS[
                        day.condition as keyof typeof WEATHER_ICONS
                      ] || Sun;
                    return (
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-4">
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
              {weatherData.map((weather) => {
                ...
                const isSelected =
                  selectedGovernorate === weather.governorate ||
