  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">324</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">أحداث حرجة</p>
            </div>
          </div>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
        ...
        <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">سيتم عرض سجل أحداث التدقيق هنا</h3>
        <p className="text-gray-500 dark:text-gray-400 text-sm">Recent audit events and activity logs will be displayed here</p>
      </div>
    </div>
  );
}
