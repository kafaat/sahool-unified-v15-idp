...
const MOCK_COOPERATIVES: Cooperative[] = [
  {
    ...
    members: [
      { id: "m001", nameAr: "أحمد محمد الحداد", role: "Chairman", joinedDate: "2019-03-15", phone: "+967 71 234 5678" },
      { id: "m002", nameAr: "سعيد علي الزبيدي", role: "Treasurer", joinedDate: "2019-03-15", phone: "+967 71 345 6789" },
      { id: "m003", nameAr: "فاطمة حسن الشرعبي", role: "Secretary", joinedDate: "2019-04-01", phone: "+967 71 456 7890" },
      { id: "m004", nameAr: "محمد عبدالله القاضي", role: "Member", joinedDate: "2019-05-10", phone: "+967 71 567 8901" },
      { id: "m005", nameAr: "عبدالرحمن يحيى المقطري", role: "Member", joinedDate: "2020-01-20", phone: "+967 71 678 9012" },
    ],
    resources: [
      { id: "r001", nameAr: "جرار زراعي كبير", type: "معدات", status: "available" },
      { id: "r002", nameAr: "مضخة ري رئيسية", type: "ري", status: "booked", bookedBy: "محمد عبدالله القاضي", returnDate: "2026-03-25" },
  ...
  },
  {
    ...
    members: [
      { id: "m101", nameAr: "عبدالكريم سالم البيضاني", role: "Chairman", joinedDate: "2020-06-01", phone: "+967 71 111 2222" },
      { id: "m102", nameAr: "نجيب عمر الأغبري", role: "Treasurer", joinedDate: "2020-06-01", phone: "+967 71 222 3333" },
      { id: "m103", nameAr: "هدى أحمد الحميري", role: "Secretary", joinedDate: "2020-07-15", phone: "+967 71 333 4444" },
      { id: "m104", nameAr: "وليد محمد المتوكل", role: "Member", joinedDate: "2020-08-01", phone: "+967 71 444 5555" },
    ],
    resources: [
      { id: "r101", nameAr: "نظام ري بالتنقيط", type: "ري", status: "available" },
      { id: "r102", nameAr: "خزان مياه رئيسي", type: "مياه", status: "booked", bookedBy: "وليد محمد المتوكل", returnDate: "2026-03-22" },
  ...
  },
  {
    ...
    members: [
      { id: "m201", nameAr: "محمد صالح الإرياني", role: "Chairman", joinedDate: "2018-09-10", phone: "+967 71 555 6666" },
      { id: "m202", nameAr: "رشيدة أحمد الوريث", role: "Treasurer", joinedDate: "2018-09-10", phone: "+967 71 666 7777" },
      { id: "m203", nameAr: "عادل حسين الدعيس", role: "Secretary", joinedDate: "2018-10-05", phone: "+967 71 777 8888" },
      { id: "m204", nameAr: "سمر علي اليوسفي", role: "Member", joinedDate: "2019-02-14", phone: "+967 71 888 9999" },
      { id: "m205", nameAr: "طارق محمد الرداعي", role: "Member", joinedDate: "2019-06-01", phone: "+967 71 999 0000" },
    ],
    resources: [
      ...
      { id: "r203", nameAr: "آلة تقشير البن", type: "معدات", status: "booked", bookedBy: "طارق محمد الرداعي", returnDate: "2026-03-30" },
    ],
    revenueHistory: [
  ...
  },
  {
    ...
    members: [
      { id: "m301", nameAr: "سلطان عوض الكثيري", role: "Chairman", joinedDate: "2021-01-20", phone: "+967 73 111 2222" },
      { id: "m302", nameAr: "بدر محمد الحامد", role: "Treasurer", joinedDate: "2021-01-20", phone: "+967 73 222 3333" },
      { id: "m303", nameAr: "منيرة سالم العمودي", role: "Secretary", joinedDate: "2021-02-10", phone: "+967 73 333 4444" },
      { id: "m304", nameAr: "عمر خالد السقاف", role: "Member", joinedDate: "2021-03-01", phone: "+967 73 444 5555" },
    ],
    resources: [
      { id: "r301", nameAr: "مصنع تعبئة التمر", type: "تصنيع", status: "available" },
      { id: "r302", nameAr: "مستودع مبرد للتمور", type: "تخزين", status: "available" },
      { id: "r303", nameAr: "آلة فرز وتدريج", type: "معدات", status: "booked", bookedBy: "عمر خالد السقاف", returnDate: "2026-03-28" },
  ...
  },
  {
    ...
    members: [
      { id: "m401", nameAr: "يحيى حسين العمري", role: "Chairman", joinedDate: "2025-11-05", phone: "+967 77 111 2222" },
      { id: "m402", nameAr: "حمد أحمد المؤيد", role: "Treasurer", joinedDate: "2025-11-05", phone: "+967 77 222 3333" },
      { id: "m403", nameAr: "أم كلثوم علي الوشلي", role: "Secretary", joinedDate: "2025-11-15", phone: "+967 77 333 4444" },
      { id: "m404", nameAr: "قاسم محمد الحوثي", role: "Member", joinedDate: "2025-12-01", phone: "+967 77 444 5555" },
    ],
    resources: [
  ...
  },
  {
    ...
    members: [
      { id: "m501", nameAr: "نادية محمد الصبيحي", role: "Chairman", joinedDate: "2020-02-28", phone: "+967 72 111 2222" },
      { id: "m502", nameAr: "إبراهيم علي الجفري", role: "Treasurer", joinedDate: "2020-02-28", phone: "+967 72 222 3333" },
      { id: "m503", nameAr: "ليلى أحمد البحري", role: "Secretary", joinedDate: "2020-03-15", phone: "+967 72 333 4444" },
      { id: "m504", nameAr: "كريم حسن العولقي", role: "Member", joinedDate: "2020-05-01", phone: "+967 72 444 5555" },
      { id: "m505", nameAr: "زينب سعيد الأمين", role: "Member", joinedDate: "2021-01-10", phone: "+967 72 555 6666" },
    ],
    resources: [
      { id: "r501", nameAr: "سوق المزارعين المركزي", type: "تسويق", status: "available" },
      { id: "r502", nameAr: "ثلاجة جماعية كبيرة", type: "تخزين", status: "booked", bookedBy: "كريم حسن العولقي", returnDate: "2026-03-20" },
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5 mb-3">
                      ...
                      <span className="text-sm text-gray-600 dark:text-gray-300">{coop.region}</span>
                    </div>

                    {/* Badges */}
                    <div className="flex flex-wrap items-center gap-2 mb-4">
                      <span className={cn("inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium", typeCfg)}>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <div className="text-center bg-white dark:bg-gray-800 rounded-lg p-2">
                        <p className="text-lg font-bold text-gray-900 dark:text-white">{coop.memberCount}</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">عضو</p>
                      </div>
                      <div className="text-center bg-white dark:bg-gray-800 rounded-lg p-2">
                        <p className="text-lg font-bold text-gray-900 dark:text-white">{coop.sharedResources}</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">مورد</p>
                      </div>
                      <div className="text-center bg-white dark:bg-gray-800 rounded-lg p-2">
                        <p className="text-lg font-bold text-gray-900 dark:text-white">{formatRevenue(coop.totalRevenue)}</p>
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700 flex items-center gap-2">
                      ...
                      <span className="text-xs text-gray-600 dark:text-gray-300 truncate">{coop.chairman}</span>
                    </div>
                  </div>
                );
              })}
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-gray-200 dark:border-gray-700">
                        <th className="text-right py-2.5 px-4 font-medium text-gray-500 dark:text-gray-400">الاسم</th>
                        <th className="text-right py-2.5 px-4 font-medium text-gray-500 dark:text-gray-400">الدور</th>
                        <th className="text-right py-2.5 px-4 font-medium text-gray-500 dark:text-gray-400">تاريخ الانضمام</th>
                        <th className="text-right py-2.5 px-4 font-medium text-gray-500 dark:text-gray-400">الهاتف</th>
                      </tr>
                    </thead>
                    <tbody>
                        ...
                        >
                          <td className="py-2.5 px-4">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-medium text-gray-900 dark:text-white">{member.nameAr}</span>
                            </div>
                          </td>
                          <td className="py-2.5 px-4">
                      ...
                      >
                        ...
                        {resource.status === "booked" && resource.bookedBy && (
                          <div className="mt-2 pt-2 border-t border-gray-200 dark:border-gray-700 text-xs text-gray-500 dark:text-gray-400 space-y-0.5">
                            ...
                            {resource.returnDate && (
                              <p>تاريخ الإعادة: {new Date(resource.returnDate).toLocaleDateString("ar-YE")}</p>
                            )}
                          </div>
                        )}
                      </div>
              ...
              <div key={coop.id} className="mb-8 last:mb-0">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
                  <div className="bg-sahool-50 dark:bg-sahool-900/30 rounded-xl p-4 border border-sahool-100 dark:border-sahool-800">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-xs text-gray-500 dark:text-gray-400">إجمالي الإيرادات</span>
                    </div>
                  ...
                  <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4 border border-green-100 dark:border-green-800">
                    ...
                    <p className="text-sm font-bold text-green-700 dark:text-green-300">
                      {coop.revenueHistory.length > 0
                        ? coop.revenueHistory.reduce<RevenueEntry | undefined>((max, e) => (max === undefined || e.amount > max.amount ? e : max), undefined)?.monthAr ?? "-"
                        : "-"}
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                  <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                    <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300">التوزيع الشهري</h4>
                  </div>
                    ...
                    {coop.revenueHistory.map((entry) => {
                      ...
                      return (
                        <div key={entry.month} className="flex items-center gap-4 px-4 py-3">
                          <span className="text-sm text-gray-600 dark:text-gray-300 w-32 flex-shrink-0">{entry.monthAr}</span>
      ...
      {selectedCoop && activeTab === "overview" && (
        <div className="mt-6 bg-white dark:bg-gray-800 rounded-xl border border-sahool-200 dark:border-sahool-700 shadow-lg overflow-hidden">
          ...
          <div className="flex items-center justify-between px-6 py-4 bg-sahool-50 dark:bg-sahool-900/30 border-b border-sahool-100 dark:border-sahool-700">
            <div>
              <h2 className="text-lg font-bold text-gray-900 dark:text-white">{selectedCoop.nameAr}</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                {selectedCoop.id} &bull; {selectedCoop.region} &bull; تأسست: {new Date(selectedCoop.foundedDate).toLocaleDateString("ar-YE")}
              </p>
            </div>
            <button
              ...
              <div className="space-y-2">
                {selectedCoop.members.map((member) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-gray-900 dark:text-white truncate">{member.nameAr}</p>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        <p className="text-sm font-medium text-gray-900 dark:text-white">{resource.nameAr}</p>
