  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex items-center gap-1.5">
        ...
        />
        <span className={cn('text-xs font-medium', RISK_LEVEL_COLORS[policy.riskLevel])}>
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-4 transition-all hover:shadow-md">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between gap-2 flex-wrap">
            <p className="font-semibold text-gray-900 dark:text-gray-100">{claim.claimNumber}</p>
            <span
              className={cn(
      ...
      <div className="mt-3 pt-3 border-t border-gray-50 dark:border-gray-700 flex items-center justify-between">
        ...
        <p className="font-bold text-gray-900 dark:text-gray-100">{formatSAR(claim.amount_SAR)}</p>
      </div>
    </div>
  );
}
    ...
    <div className="space-y-5">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between py-2 border-b border-gray-50 dark:border-gray-700">
            ...
            <span className="font-medium text-gray-900 dark:text-gray-100">{policy.cropAr}</span>
          </div>
          <div className="flex items-center justify-between py-2 border-b border-gray-50 dark:border-gray-700">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5">
        ...
        <div className="flex items-center gap-2 mb-4">
          <div className={cn('text-3xl font-bold', RISK_LEVEL_COLORS[policy.riskLevel])}>
            {score}
          </div>
          <div>
            <p className={cn('text-sm font-semibold', RISK_LEVEL_COLORS[policy.riskLevel])}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {(['low', 'moderate', 'high'] as RiskLevel[]).map((level) => {
              ...
              return (
                <div
                  key={level}
                  className={cn('rounded-xl border p-5 flex items-center gap-4', colorMap[level])}
                >
                  <div
                    className={cn(
                  ...
                  >
                    <Shield className={cn('w-6 h-6', RISK_LEVEL_COLORS[level])} />
                  </div>
                  <div>
                    <p className={cn('text-2xl font-bold', RISK_LEVEL_COLORS[level])}>{count}</p>
              ...
              {[
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">{factor.desc}</p>
