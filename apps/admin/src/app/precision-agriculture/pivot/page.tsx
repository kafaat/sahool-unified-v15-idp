    ...
    <div className="p-6">
      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <h3 className="font-bold text-gray-900">المحاور المسجلة</h3>
          {isLoading ? (
            ...
            pivots.map((pivot) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <h4 className="font-bold text-gray-900">{pivot.name_ar}</h4>
              ...
              <div className="bg-white rounded-xl border border-gray-100 p-6">
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-sahool-600"
                    readOnly
                  />
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-xs text-gray-500">الأبراج</p>
                  </div>
                  <div className="text-center p-3 bg-gray-50 rounded-lg">
                    <p className="text-lg font-bold text-gray-900">
                      {selectedPivot.sectors_count}
                    </p>
                    <p className="text-xs text-gray-500">القطاعات</p>
                  </div>
                  <div className="text-center p-3 bg-gray-50 rounded-lg">
                    <p className="text-lg font-bold text-blue-600">
                      {selectedPivot.vri_zones_count}
                    </p>
                    <p className="text-xs text-gray-500">مناطق VRI</p>
                  </div>
                  <div className="text-center p-3 bg-gray-50 rounded-lg">
                    <p className="text-lg font-bold text-gray-900">
                      {selectedPivot.application_rate_mm_hr}
                    </p>
                    <p className="text-xs text-gray-500">ملم/ساعة</p>
                  </div>
                </div>
              </div>
