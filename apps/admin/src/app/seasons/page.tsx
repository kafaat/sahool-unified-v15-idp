...
const SEASON_TYPE_CONFIG: Record<
  SeasonType,
  { label: string; labelAr: string; icon: typeof Sun; color: string }
> = {
  winter: {
    label: 'Winter',
    labelAr: 'شتاء',
...
const WHEAT_GROWTH_STAGES: GrowthStage[] = [
  {
    ...
    descriptionAr: 'امتصاص البذرة للماء والإنبات',
    waterMultiplier: 0.4,
    nutrientRequirements: { nitrogen: 0, phosphorus: 20, potassium: 10 },
  },
  {
    id: 'gs-2',
    name: 'Seedling',
    ...
    descriptionAr: 'ظهور الأوراق الأولى',
    waterMultiplier: 0.5,
    nutrientRequirements: { nitrogen: 15, phosphorus: 15, potassium: 10 },
  },
  {
    id: 'gs-3',
    name: 'Tillering',
    nameAr: 'التفريع',
    durationDays: 25,
    description: 'Side shoots develop',
    descriptionAr: 'نمو الأشطاء الجانبية',
    waterMultiplier: 0.7,
    nutrientRequirements: { nitrogen: 40, phosphorus: 10, potassium: 15 },
  },
  {
    id: 'gs-4',
    ...
    durationDays: 20,
    description: 'Stem grows rapidly',
    descriptionAr: 'نمو سريع للساق',
    waterMultiplier: 0.9,
    nutrientRequirements: { nitrogen: 30, phosphorus: 5, potassium: 20 },
  },
  {
    id: 'gs-5',
    name: 'Heading',
    nameAr: 'طرد السنابل',
    durationDays: 15,
    description: 'Ear emerges from flag leaf',
    descriptionAr: 'خروج السنبلة من ورقة العلم',
    waterMultiplier: 1.0,
    nutrientRequirements: { nitrogen: 20, phosphorus: 5, potassium: 15 },
  },
  {
    id: 'gs-6',
    name: 'Flowering',
    ...
    descriptionAr: 'حدوث التلقيح',
    waterMultiplier: 1.0,
    nutrientRequirements: { nitrogen: 10, phosphorus: 5, potassium: 10 },
  },
  {
    id: 'gs-7',
    name: 'Grain Fill',
    ...
    durationDays: 25,
    description: 'Grain develops and fills',
    descriptionAr: 'تطور وامتلاء الحبوب',
    waterMultiplier: 0.8,
    nutrientRequirements: { nitrogen: 5, phosphorus: 5, potassium: 10 },
  },
  {
    id: 'gs-8',
    name: 'Maturity',
    nameAr: 'النضج',
    durationDays: 15,
    description: 'Grain dries and hardens',
    descriptionAr: 'جفاف وتصلب الحبوب',
    waterMultiplier: 0.3,
    nutrientRequirements: { nitrogen: 0, phosphorus: 0, potassium: 5 },
  },
];
...
const WHEAT_FERTILIZER_PLAN: FertilizerRecommendation[] = [
  {
    ...
    stageAr: 'قبل الزراعة',
    product: 'DAP (18-46-0)',
    productAr: 'داب (18-46-0)',
    rateKgPerHa: 100,
    method: 'Broadcast',
    methodAr: 'نثر',
    timing: 'During soil preparation',
    timingAr: 'أثناء تحضير التربة',
    notes: 'Apply before last plowing',
    notesAr: 'يضاف قبل الحرثة الأخيرة',
  },
  {
    id: 'f-2',
    stage: 'Tillering',
    ...
    method: 'Top dressing',
    methodAr: 'تسميد سطحي',
    timing: '30-35 days after planting',
    timingAr: '30-35 يوم بعد الزراعة',
    notes: 'Apply early morning with dew',
    notesAr: 'يضاف في الصباح الباكر مع الندى',
  },
  {
    id: 'f-3',
    stage: 'Stem Elongation',
    stageAr: 'استطالة الساق',
    product: 'Urea 46%',
    productAr: 'يوريا 46%',
    rateKgPerHa: 45,
    method: 'Top dressing',
    methodAr: 'تسميد سطحي',
    timing: '55-60 days after planting',
    timingAr: '55-60 يوم بعد الزراعة',
    notes: 'Second nitrogen dose',
    notesAr: 'الجرعة الثانية من النيتروجين',
  },
  {
    id: 'f-4',
    stage: 'Heading',
    ...
    productAr: 'سلفات البوتاسيوم',
    rateKgPerHa: 30,
    method: 'Foliar spray',
    methodAr: 'رش ورقي',
    timing: 'At heading stage',
    timingAr: 'عند طرد السنابل',
    notes: 'Improves grain quality',
    notesAr: 'يحسن جودة الحبوب',
  },
];
...
const WHEAT_PESTICIDE_PLAN: PesticideRecommendation[] = [
  {
    ...
    productAr: 'بروبيكونازول 25% مركز',
    activeIngredient: 'Propiconazole',
    ratePerHa: '0.5 L/ha',
    timing: 'Preventive at tillering, repeat at heading if needed',
    timingAr: 'وقائياً عند التفريع، يكرر عند طرد السنابل إذا لزم',
    phi: 35,
    safetyNotes: 'Wear protective gloves and mask',
    safetyNotesAr: 'ارتداء قفازات واقية وكمامة',
  },
  {
    id: 'p-2',
    pest: 'Aphids',
    pestAr: 'المن',
    type: 'insecticide',
    product: 'Imidacloprid 20% SL',
    productAr: 'إيميداكلوبريد 20%',
    activeIngredient: 'Imidacloprid',
    ratePerHa: '0.25 L/ha',
    timing: 'When 10+ aphids per tiller observed',
    timingAr: 'عند ملاحظة 10+ حشرات من لكل إشطاء',
    phi: 21,
    safetyNotes: 'Toxic to bees - do not apply during flowering',
    safetyNotesAr: 'سام للنحل - لا يرش أثناء الإزهار',
  },
  {
    id: 'p-3',
    pest: 'Broadleaf Weeds',
    pestAr: 'الأعشاب عريضة الأوراق',
    type: 'herbicide',
    product: '2,4-D Amine 72%',
    productAr: '2,4-دي أمين 72%',
    activeIngredient: '2,4-Dichlorophenoxyacetic acid',
    ratePerHa: '1.0 L/ha',
    timing: 'At 3-5 leaf stage of weeds',
    timingAr: 'عند مرحلة 3-5 أوراق للأعشاب',
    phi: 30,
    safetyNotes: 'Do not spray near other crops - drift risk',
    safetyNotesAr: 'لا يرش بالقرب من محاصيل أخرى - خطر الانجراف',
  },
  {
    id: 'p-4',
    pest: 'Sunn Pest',
    pestAr: 'حشرة السونة',
    type: 'insecticide',
    product: 'Deltamethrin 2.5% EC',
    productAr: 'دلتاميثرين 2.5% مركز',
    activeIngredient: 'Deltamethrin',
    ratePerHa: '0.5 L/ha',
    timing: 'At grain fill stage when density exceeds threshold',
    timingAr: 'عند مرحلة امتلاء الحبوب عند تجاوز الكثافة للعتبة',
    phi: 14,
    safetyNotes: 'Apply in early morning or late evening',
    safetyNotesAr: 'يرش في الصباح الباكر أو المساء المتأخر',
  },
];
...
const MOCK_SEASONS: Season[] = [
  {
    ...
    crops: [
      ...
      },
      {
        ...
        fertilizerPlan: WHEAT_FERTILIZER_PLAN.map((f) => ({
          ...f,
          id: `f-b-${f.id}`,
          rateKgPerHa: Math.round(f.rateKgPerHa * 0.8),
        })),
        ...
        growthStages: [
          {
            ...
            descriptionAr: 'ظهور البادرة',
            waterMultiplier: 0.5,
            nutrientRequirements: { nitrogen: 0, phosphorus: 25, potassium: 15 },
          },
          {
            id: 'gs-a-2',
            name: 'Vegetative',
            ...
            descriptionAr: 'نمو الأوراق والسيقان',
            waterMultiplier: 0.8,
            nutrientRequirements: { nitrogen: 10, phosphorus: 10, potassium: 20 },
          },
          {
            id: 'gs-a-3',
            name: 'Flowering',
          ...
          },
          {
            ...
            nameAr: 'الحصاد',
            durationDays: 5,
            description: 'Cut at 10% bloom',
            descriptionAr: 'الحش عند 10% إزهار',
            waterMultiplier: 0.3,
          },
        ],
        fertilizerPlan: [
          {
            ...
            stageAr: 'قبل الزراعة',
            product: 'SSP (0-18-0)',
            productAr: 'سوبر فوسفات (0-18-0)',
            rateKgPerHa: 150,
            method: 'Broadcast',
            methodAr: 'نثر',
            timing: 'Before plowing',
            timingAr: 'قبل الحراثة',
            notes: 'Essential for root development',
            notesAr: 'ضروري لتطور الجذور',
          },
          {
            id: 'f-a-2',
            stage: 'After each cut',
            stageAr: 'بعد كل حشة',
            product: 'NPK 20-20-20',
            productAr: 'مركب 20-20-20',
            rateKgPerHa: 50,
            method: 'Fertigation',
            methodAr: 'تسميد مع الري',
            timing: '1-2 days after cutting',
            timingAr: '1-2 يوم بعد الحش',
            notes: 'Promotes regrowth',
            notesAr: 'يعزز النمو الجديد',
          },
        ],
        pesticidePlan: [
          {
            ...
            productAr: 'لامبدا سيهالوثرين',
            activeIngredient: 'Lambda-cyhalothrin',
            ratePerHa: '0.3 L/ha',
            timing: 'When 30%+ tips show damage',
            timingAr: 'عند تضرر 30% من القمم',
            phi: 7,
            safetyNotes: 'Short PHI - safe for frequent harvest',
            safetyNotesAr: 'فترة أمان قصيرة - آمن للحصاد المتكرر',
          },
        ],
      },
    ],
    ...
    crops: [
      {
        ...
        growthStages: [
          ...
          },
          {
            ...
            nameAr: 'النمو الخضري',
            durationDays: 30,
            description: 'Vine growth',
            descriptionAr: 'نمو العرش',
            waterMultiplier: 0.8,
          },
          {
            id: 'gs-t-3',
            ...
            nameAr: 'الإزهار',
            durationDays: 20,
            description: 'Flower clusters form',
            descriptionAr: 'تكون العناقيد الزهرية',
            waterMultiplier: 1.0,
          },
          {
            id: 'gs-t-4',
          ...
          },
          {
            ...
            descriptionAr: 'نضج الثمار والحصاد',
            waterMultiplier: 0.7,
          },
        ],
        fertilizerPlan: [
          {
            ...
            stageAr: 'قبل الزراعة',
            product: 'Compost + DAP',
            productAr: 'كمبوست + داب',
            rateKgPerHa: 200,
            method: 'Band',
            methodAr: 'سطور',
            timing: 'Before transplanting',
            timingAr: 'قبل الشتل',
            notes: 'Mix organic with mineral',
            notesAr: 'خلط عضوي مع معدني',
          },
          {
            id: 'f-t-2',
            stage: 'Fruiting',
            ...
            productAr: 'نترات الكالسيوم',
            rateKgPerHa: 80,
            method: 'Fertigation',
            methodAr: 'تسميد مع الري',
            timing: 'Weekly during fruiting',
            timingAr: 'أسبوعياً أثناء الإثمار',
            notes: 'Prevents blossom end rot',
            notesAr: 'يمنع تعفن الطرف الزهري',
          },
        ],
        pesticidePlan: [
          {
            ...
            pestAr: 'حافرة أوراق الطماطم',
            type: 'insecticide',
            product: 'Abamectin 1.8% EC',
            productAr: 'أبامكتين 1.8%',
            activeIngredient: 'Abamectin',
            ratePerHa: '0.5 L/ha',
            timing: 'At first mines observed',
            timingAr: 'عند أول ظهور لأنفاق',
            phi: 3,
            safetyNotes: 'Avoid spraying in high temperatures',
            safetyNotesAr: 'تجنب الرش في درجات الحرارة المرتفعة',
          },
          {
            id: 'p-t-2',
            pest: 'Late Blight',
            pestAr: 'اللفحة المتأخرة',
            type: 'fungicide',
            product: 'Mancozeb 80% WP',
            productAr: 'مانكوزيب 80%',
            activeIngredient: 'Mancozeb',
            ratePerHa: '2.0 kg/ha',
            timing: 'Preventive every 7-10 days in humid conditions',
            timingAr: 'وقائياً كل 7-10 أيام في الظروف الرطبة',
            phi: 7,
            safetyNotes: 'Wear full protective equipment',
            safetyNotesAr: 'ارتداء معدات الوقاية الكاملة',
          },
        ],
      },
    ],
    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        ...
        <div
          ...
          style={{ gridTemplateColumns: `repeat(${Math.min(stages.length, 4)}, 1fr)` }}
        >
          {stages.map((stage) => {
              ...
              <div key={stage.id} className="text-center">
                ...
                {stage.nutrientRequirements && (
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">
                    N:{stage.nutrientRequirements.nitrogen} P:
                    {stage.nutrientRequirements.phosphorus} K:{stage.nutrientRequirements.potassium}
                  </p>
                )}
              </div>
            );
...
function PesticidePlanTable({ plan }: { plan: PesticideRecommendation[] }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-3">
        {plan.map((rec) => {
          const typeConfig = typeLabels[rec.type] ??
            typeLabels.insecticide ?? { label: rec.type, color: 'bg-gray-100 text-gray-700' };
          return (
            <div
              key={rec.id}
      ...
      <div className="bg-gradient-to-l from-sahool-600 to-sahool-700 p-4 text-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sahool-100 text-sm">
              {crop.varietyAr} • {CATEGORY_LABELS[crop.category]} • {crop.areaHa} هكتار
            </p>
          </div>
...
function CreateSeasonModal({
  ...
  onClose: () => void;
  onSubmit: (data: Partial<Season>) => void;
}) {
            ...
            {[1, 2, 3].map((s) => (
              <div key={s} className="flex-1 flex items-center gap-2">
                ...
                <span
                  className={cn(
                    'text-xs',
                    s <= step ? 'text-sahool-700 dark:text-sahool-400 font-medium' : 'text-gray-400'
                  )}
                >
                ...
                {s < 3 && (
                  <div
                    className={cn(
                      'flex-1 h-0.5',
                      s < step ? 'bg-sahool-600' : 'bg-gray-200 dark:bg-gray-700'
                    )}
                  />
                )}
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    value={formData.type}
                    onChange={(e) =>
                      setFormData({ ...formData, type: e.target.value as SeasonType })
                    }
                    className="w-full px-4 py-2.5 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-sahool-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                  >
                    {(
                      Object.entries(SEASON_TYPE_CONFIG) as [
                        SeasonType,
                        (typeof SEASON_TYPE_CONFIG)[SeasonType],
                      ][]
                    ).map(([key, val]) => (
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, targetYieldTons: parseFloat(e.target.value) || 0 })
                    }
                    className="w-full px-4 py-2.5 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-sahool-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, budgetSar: parseFloat(e.target.value) || 0 })
                    }
                    className="w-full px-4 py-2.5 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-sahool-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                  />
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, cropArea: parseFloat(e.target.value) || 0 })
                    }
                    className="w-full px-4 py-2.5 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-sahool-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                  />
                </div>
              ...
              {formData.selectedCrop && (
                <div className="bg-sahool-50 dark:bg-sahool-900/20 rounded-xl p-4 border border-sahool-200 dark:border-sahool-800">
                  <p className="text-sm text-sahool-700 dark:text-sahool-300 font-medium flex items-center gap-2">
                    ...
                    سيتم تحميل مراحل النمو وتوصيات التسميد والمبيدات تلقائياً بناءً على المحصول
                    المختار
                  </p>
                </div>
              )}
    ...
    return seasons.filter((s) => {
      if (searchQuery) {
        ...
        if (
          ...
          !s.farmNameAr.toLowerCase().includes(q)
        )
          return false;
      }
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                          {season.farmNameAr} • {formatDate(season.startDate)} -{' '}
                  ...
                  {season.progress > 0 && (
                    <div className="mt-3 flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                        <span>
                          الميزانية: {formatNumber(season.spentSar)} /{' '}
                          {formatNumber(season.budgetSar)} ريال ({budgetPercent}%)
                        </span>
                      </div>
                    </div>
                  )}
                    ...
                    {season.crops.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                          لم تتم إضافة محاصيل لهذا الموسم بعد
                        </p>
                        <button
                          disabled
                          className="mt-3 text-sm text-sahool-600 font-medium disabled:opacity-40 disabled:cursor-not-allowed"
                          title="إضافة محصول (قريبًا)"
                        >
                          + إضافة محصول
                        </button>
                      </div>
