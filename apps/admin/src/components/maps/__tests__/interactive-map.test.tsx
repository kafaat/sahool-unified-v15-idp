...
describe('MapOverview', () => {
  ...
  it("renders 'view all' link to farms page", () => {
    ...
    expect(screen.getByText('عرض الكل ←').closest('a')).toHaveAttribute('href', '/farms');
  });
  ...
  it('accepts custom className', () => {
    const { container } = render(<MapOverview farms={sampleFarms} className="custom-class" />);
...
describe('FarmsMap Source Verification', () => {
  ...
  const farmsMapPath = path.resolve(__dirname, '../../maps/FarmsMap.tsx');
