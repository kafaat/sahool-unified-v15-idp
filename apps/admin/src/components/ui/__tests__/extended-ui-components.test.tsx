...
describe('SearchFilter', () => {
    ...
    const filters = [
      {
        ...
        labelAr: 'الحالة',
        type: 'select' as const,
        options: [{ value: 'active', label: 'Active', labelAr: 'نشط' }],
      },
    ];
    render(<SearchFilter filters={filters} />);
  ...
  it('shows active filter count', () => {
    ...
    const activeFilters = [{ key: 'status', value: 'active', label: 'الحالة' }];
    render(<SearchFilter filters={filters} activeFilters={activeFilters} showFilterCount={true} />);
  ...
  it('calls onFilterChange when removing a filter chip', () => {
    ...
    const activeFilters = [{ key: 'status', value: 'active', label: 'الحالة' }];
    render(<SearchFilter activeFilters={activeFilters} onFilterChange={onFilterChange} />);
...
describe('BulkActions', () => {
  it('returns null when no items selected', () => {
    const { container } = render(<BulkActions selectedCount={0} totalCount={100} />);
  ...
  it('shows select all button when not all selected', () => {
    ...
    render(<BulkActions selectedCount={5} totalCount={100} onSelectAll={onSelectAll} />);
  ...
  it('shows deselect button', () => {
    ...
    render(<BulkActions selectedCount={5} totalCount={100} onDeselectAll={onDeselectAll} />);
  ...
  it('renders custom actions', () => {
    ...
    render(<BulkActions selectedCount={3} totalCount={10} actions={customActions} />);
