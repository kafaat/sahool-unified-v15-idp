...
function ToastTrigger() {
  ...
  return (
    <div>
      <button onClick={() => toast.success('Done', 'تمت العملية')}>Success</button>
      <button onClick={() => toast.error('Error occurred', 'حدث خطأ')}>Error</button>
      <button onClick={() => toast.warning('Warning', 'تحذير')}>Warning</button>
