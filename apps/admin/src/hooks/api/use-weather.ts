 ...
 */
export function useWeatherCurrent(lat: number, lon: number, fieldId?: string) {
  return useApiQuery(
 ...
 */
export function useWeatherForecast(lat: number, lon: number, days: number = 7, fieldId?: string) {
  return useApiQuery(
 ...
 */
export function useAgriculturalReport(lat: number, lon: number, fieldId?: string) {
  return useApiQuery(
...
export function useWeatherByLocation(locationId: string) {
  return useApiQuery(['weather', 'location', locationId], () => getWeatherByLocation(locationId), {
    enabled: !!locationId,
 ...
 */
export function useWeatherForecastByLocation(locationId: string, days: number = 7) {
  return useApiQuery(
...
export function useWeatherAlerts(locationId: string = 'sanaa') {
  return useApiQuery(['weather', 'alerts', locationId], () => fetchWeatherAlerts(locationId), {
    enabled: !!locationId,
    refetchInterval: 300000,
  });
}
