 ...
 * GET request
 */
export function get<T>(service: ServiceName, endpoint: string, params?: Record<string, unknown>): Promise<ApiResponse<T>> {
 ...
 * POST request
 */
export function post<T>(service: ServiceName, endpoint: string, data?: unknown): Promise<ApiResponse<T>> {
 ...
 * PUT request
 */
export function put<T>(service: ServiceName, endpoint: string, data?: unknown): Promise<ApiResponse<T>> {
