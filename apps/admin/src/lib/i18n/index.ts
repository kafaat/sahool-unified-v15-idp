...
export function t(
  ...
  const localeTranslations =
    translations[currentLocale] || translations[config.fallbackLocale];
  let text: string =
    localeTranslations[key] || translations[config.fallbackLocale][key] || key;
...
export function tp(
  ...
  return t(pluralKey in translations[currentLocale] ? pluralKey : key, {
    count,
    ...params,
  });
}
