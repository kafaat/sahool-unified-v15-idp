...
def main():
    ...
    print(f"  • الميزات الأكثر استخداماً - Most Used Features: {metrics.most_used_features}\n")
    ...
    print(f"  • الاحتفاظ في اليوم 1 - Day 1 Retention: {cohort_analysis.retention_day_1:.2%}")
    print(f"  • الاحتفاظ في اليوم 7 - Day 7 Retention: {cohort_analysis.retention_day_7:.2%}")
    print(f"  • الاحتفاظ في اليوم 30 - Day 30 Retention: {cohort_analysis.retention_day_30:.2%}")
    print(f"  • الاحتفاظ في اليوم 90 - Day 90 Retention: {cohort_analysis.retention_day_90:.2%}\n")
