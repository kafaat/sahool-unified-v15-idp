...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_sensor_readings_reading_type", "sensor_readings", ["reading_type"]
    )
    ...
    op.create_index("ix_sahool_migrations_revision", "sahool_migrations", ["revision"])
    op.create_index(
        "ix_sahool_migrations_applied_at", "sahool_migrations", ["applied_at"]
    )
