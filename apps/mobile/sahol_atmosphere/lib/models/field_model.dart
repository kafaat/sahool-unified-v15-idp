  ...
  static List<FieldModel> get all => [
        FieldModel(
          ...
          boundary: [
            ...
            LatLng(15.3700, 44.1920),
            LatLng(15.3695, 44.1930),
            LatLng(15.3685, 44.1925),
            LatLng(15.3694, 44.1910),
          ],
        ...
        FieldModel(
          ...
          sunlightPercent: 92,
          boundary: [
            LatLng(15.3710, 44.1940),
            LatLng(15.3720, 44.1950),
            LatLng(15.3715, 44.1960),
            LatLng(15.3705, 44.1955),
            LatLng(15.3710, 44.1940),
          ],
          center: LatLng(15.3712, 44.1950),
        ...
        FieldModel(
          ...
          sunlightPercent: 78,
          boundary: [
            LatLng(15.3650, 44.1870),
            LatLng(15.3670, 44.1890),
            LatLng(15.3660, 44.1910),
            LatLng(15.3640, 44.1890),
            LatLng(15.3650, 44.1870),
          ],
          center: LatLng(15.3655, 44.1890),
        ...
        FieldModel(
          ...
          sunlightPercent: 95,
          boundary: [
            LatLng(15.3730, 44.1880),
            LatLng(15.3740, 44.1890),
            LatLng(15.3735, 44.1900),
            LatLng(15.3725, 44.1895),
            LatLng(15.3730, 44.1880),
          ],
          center: LatLng(15.3732, 44.1890),
        ...
        FieldModel(
          ...
          sunlightPercent: 60,
          boundary: [
            LatLng(15.3600, 44.1920),
            LatLng(15.3620, 44.1940),
            LatLng(15.3610, 44.1960),
            LatLng(15.3590, 44.1940),
            LatLng(15.3600, 44.1920),
          ],
          center: LatLng(15.3605, 44.1940),
