...
class AlertCreate(BaseModel):
    ...
    recommendations: list[str] | None = Field(default=None, description="التوصيات")
    recommendations_en: list[str] | None = Field(default=None, description="التوصيات بالإنجليزية")
    metadata: dict[str, Any] | None = Field(default=None, description="بيانات إضافية")
