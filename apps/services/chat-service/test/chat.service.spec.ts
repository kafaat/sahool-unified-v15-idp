...
describe("ChatService", () => {
  ...
  describe("createConversation - إنشاء محادثة", () => {
    it("should create a new conversation successfully", async () => {
      ...
      const result = await service.createConversation(createDto, TENANT_ID);
    ...
    it("should create conversation with correct participant roles", async () => {
      ...
      await service.createConversation(createDto, TENANT_ID);
  ...
  describe("sendMessage - إرسال رسالة", () => {
    it("should send a message successfully", async () => {
      ...
      const result = await service.sendMessage(sendDto, TENANT_ID);

      expect(result).toBeDefined();
      expect(mockPrismaService.conversation.findFirst).toHaveBeenCalledWith({
        where: { id: "conv-123", tenantId: TENANT_ID },
      });
    });
    ...
    it("should throw NotFoundException when conversation not found", async () => {
      ...
      await expect(service.sendMessage(sendDto, TENANT_ID)).rejects.toThrow(
        NotFoundException,
      );
    });
    ...
    it("should increment unread count for other participants", async () => {
      ...
      await service.sendMessage(sendDto, TENANT_ID);
  ...
  describe("getMessages - جلب الرسائل", () => {
    it("should get messages for a conversation with pagination", async () => {
      ...
      const result = await service.getMessages("conv-123", 1, 50, TENANT_ID);
      ...
      expect(mockPrismaService.message.findMany).toHaveBeenCalledWith({
        where: { conversationId: "conv-123", tenantId: TENANT_ID },
        orderBy: { createdAt: "desc" },
        skip: 0,
        take: 50,
      });
    ...
    it("should handle pagination correctly for page 2", async () => {
      ...
      const result = await service.getMessages("conv-123", 2, 50, TENANT_ID);
    ...
    it("should calculate total pages correctly", async () => {
      ...
      const result = await service.getMessages("conv-123", 1, 25, TENANT_ID);
  ...
  describe("getConversationById - جلب المحادثة بالمعرف", () => {
    it("should return conversation by ID", async () => {
      ...
      const result = await service.getConversationById("conv-123", TENANT_ID);
    ...
    it("should throw NotFoundException when conversation not found", async () => {
      ...
      await expect(service.getConversationById("conv-999", TENANT_ID)).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe("getUserConversations - جلب محادثات المستخدم", () => {
    it("should return all conversations for a user", async () => {
      ...
      const result = await service.getUserConversations("user-123", TENANT_ID);
  ...
  describe("markMessageAsRead - تحديد الرسالة كمقروءة", () => {
    it("should mark message as read", async () => {
      ...
      const result = await service.markMessageAsRead("msg-123", "user-456", TENANT_ID);
    ...
    it("should not mark message as read if user is the sender", async () => {
      ...
      await service.markMessageAsRead("msg-123", "user-123", TENANT_ID);
    ...
    it("should throw NotFoundException when message not found", async () => {
      ...
      await expect(
        service.markMessageAsRead("msg-999", "user-123", TENANT_ID),
  ...
  describe("getUnreadCount - عدد الرسائل غير المقروءة", () => {
    it("should return total unread count for user", async () => {
      ...
      const result = await service.getUnreadCount("user-123", TENANT_ID);

      expect(result).toBe(10);
      expect(mockPrismaService.participant.findMany).toHaveBeenCalledWith({
        where: { userId: "user-123", tenantId: TENANT_ID },
  ...
  describe("markConversationAsRead - تحديد المحادثة كمقروءة", () => {
    ...
    it("should reset unread count for participant", async () => {
      ...
      await service.markConversationAsRead("conv-123", "user-456", TENANT_ID);
  ...
  describe("updateOnlineStatus - تحديث حالة الاتصال", () => {
    it("should update user online status", async () => {
      ...
      const result = await service.updateOnlineStatus("user-123", true, TENANT_ID);
    ...
    it("should set user offline status", async () => {
      ...
      const result = await service.updateOnlineStatus("user-123", false, TENANT_ID);
