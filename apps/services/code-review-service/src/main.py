...
from fastapi import FastAPI, HTTPException, status, Request, Header, BackgroundTasks
...
from agricultural_rules import AgriculturalRulesEngine, AgriculturalAnalysis
...
class CodeReviewService:
    ...
    def _create_review_prompt(
        ...
        content: str,
        language: Optional[str] = None,
        agri_analysis: Optional[AgriculturalAnalysis] = None
    ) -> str:
...
"""
        ...
        if agri_analysis and agri_analysis.is_agricultural_code:
            prompt += agri_analysis.get_enhanced_prompt(agri_analysis) if hasattr(self.agricultural_engine, 'get_enhanced_prompt') else ""
...
_service_instance: Optional[CodeReviewService] = None
