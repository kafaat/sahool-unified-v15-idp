...
class TestScenarios:
    def test_scenario_comparison(self, client):
        response = client.post("/api/v1/digital-twin/scenarios", json={
            "field_state": {
                "field_id": "FIELD-001",
                "crop": "wheat",
...
class TestOptimization:
    def test_balanced_optimization(self, client):
        response = client.post("/api/v1/digital-twin/optimize", json={
            "field_state": {
                "field_id": "FIELD-001",
                "crop": "wheat",
                "soil_moisture_pct": 50.0,
...
class TestStateUpdate:
    def test_update_state(self, client):
        response = client.post("/api/v1/digital-twin/state/update", json={
            "field_id": "FIELD-001",
