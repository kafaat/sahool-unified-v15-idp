...
import { DisasterType, Severity, DisasterStatus } from '../disaster/disaster.dto';
...
describe('DisasterService', () => {
  ...
  describe('getActiveDisasters', () => {
    ...
    it('should filter by disaster type', async () => {
      ...
      expect(result.disasters.every((d) => d.type === DisasterType.FLOOD)).toBe(true);
    });
    ...
    it('should filter by governorate', async () => {
      ...
      expect(result.disasters.every((d) => d.governorate === 'hadramaut')).toBe(true);
    });
    ...
    it('should filter by severity', async () => {
      ...
      expect(result.disasters.every((d) => d.severity === Severity.HIGH)).toBe(true);
    });
