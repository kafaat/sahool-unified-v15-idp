...
class TestProfitabilityAPI:
    ...
    def test_get_benchmarks(self):
        ...
        response = client.get(
            "/v1/profitability/benchmarks/coffee",
            params={"region": "sanaa"}
        )
        assert response.status_code == 200
    ...
    def test_get_benchmarks_invalid_crop(self):
        ...
        response = client.get(
            "/v1/profitability/benchmarks/invalid_crop",
            params={"region": "sanaa"}
        )
    ...
    def test_cost_breakdown(self):
        """Test cost breakdown"""
        response = client.get(
            "/v1/profitability/cost-breakdown/wheat",
            params={"area_ha": 2.5}
        )
        assert response.status_code == 200
    ...
    def test_historical_profitability(self):
        ...
        response = client.get(
            "/v1/profitability/history/field-001/wheat",
            params={"years": 3}
        )
        assert response.status_code == 200
