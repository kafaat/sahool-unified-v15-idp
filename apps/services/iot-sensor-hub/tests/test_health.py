...
class TestNodeManagement:
    def test_register_node(self, client):
        response = client.post("/api/v1/iot/nodes", json={
            "node_id": "NODE-001",
    ...
    def test_list_nodes(self, client):
        # Register first
        client.post("/api/v1/iot/nodes", json={
            "node_id": "NODE-002",
            "node_type": "esp32_lora",
            "name": "Field Sensor 2",
            "field_id": "FIELD-001",
...
class TestSensorIngestion:
    ...
    def test_batch_ingestion(self, client):
        response = client.post("/api/v1/iot/readings/batch", json={
            "readings": [
...
class TestWDI:
    def test_wdi_high_stress(self, client):
        response = client.post("/api/v1/iot/wdi", json={
            "field_id": "FIELD-001",
            "soil_moisture": 15.0,
            "temperature": 42.0,
            "humidity": 20.0,
