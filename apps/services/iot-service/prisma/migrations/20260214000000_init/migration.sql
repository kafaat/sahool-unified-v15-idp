-- Migration: Initial schema for iot-service
-- Idempotent: all statements use IF NOT EXISTS / exception-safe DO blocks
...
-- Step 3: Create indexes (safe: no-op if already exist)
...
-- Step 4: Add foreign key constraints (safe: no-op if already exist)
DO $$ BEGIN
