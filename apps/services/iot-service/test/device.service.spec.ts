...
describe("IotService - Device Management", () => {
  ...
  describe("Device Authentication", () => {
    it("should accept device with valid topic structure", async () => {
      ...
      const topic =
        "sahool/tenant-123/farm/farm-456/field/field-789/sensor/soil_moisture";
      const payload = JSON.stringify({
    ...
    it("should handle device message from valid tenant", async () => {
      ...
      const topic =
        "sahool/valid-tenant/farm/farm-1/field/field-1/device/status";
      const payload = JSON.stringify({
    ...
    it("should process messages with proper authentication context", async () => {
      ...
      const topic =
        "sahool/tenant-001/farm/farm-001/field/field-001/device/status";
