...
--   * CREATE INDEX IF NOT EXISTS               — safe inside Prisma transaction
--
...
-- Add missing columns to pre-existing idempotency_keys table (idempotent)
ALTER TABLE idempotency_keys ADD COLUMN IF NOT EXISTS user_id UUID;
ALTER TABLE idempotency_keys ADD COLUMN IF NOT EXISTS operation TEXT NOT NULL DEFAULT '';
