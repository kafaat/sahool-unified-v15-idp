...
describe('AppController (Marketplace)', () => {
  ...
  describe('GET /market/products', () => {
    ...
    it('should filter products by price range', async () => {
      ...
      await controller.getProducts(undefined, undefined, undefined, '500', '2000');
  ...
  describe('GET /market/products/:id', () => {
    ...
    it('should handle product not found', async () => {
      ...
      await expect(controller.getProduct('999')).rejects.toThrow('المنتج غير موجود');
    });
  });
  ...
  describe('POST /market/products', () => {
    it('should create a new product', async () => {
      ...
      expect(mockMarketService.createProduct).toHaveBeenCalledWith(createProductDto);
    });
    ...
    it('should validate product data', async () => {
      ...
      await expect(controller.createProduct(invalidProductDto as any)).rejects.toThrow();
    });
  });
  ...
  describe('POST /market/orders', () => {
    it('should create a new order', async () => {
      ...
      expect(mockMarketService.createOrder).toHaveBeenCalledWith(createOrderDto);
    });
    ...
    it('should handle insufficient stock error', async () => {
      ...
      await expect(controller.createOrder(createOrderDto as any)).rejects.toThrow(
  ...
  describe('GET /market/orders/:userId', () => {
    it('should return buyer orders for authorized user', async () => {
      ...
      const result = await controller.getUserOrders(mockRequest, userId, 'buyer');

      expect(result).toEqual(mockOrders);
      expect(mockMarketService.getUserOrders).toHaveBeenCalledWith(userId, 'buyer');
    });
    ...
    it('should return seller orders for authorized user', async () => {
      ...
      const result = await controller.getUserOrders(mockRequest, userId, 'seller');

      expect(result).toEqual(mockOrders);
      expect(mockMarketService.getUserOrders).toHaveBeenCalledWith(userId, 'seller');
    });
