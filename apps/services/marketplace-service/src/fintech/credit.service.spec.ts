...
describe('CreditService', () => {
  ...
  describe('calculateAdvancedCreditScore', () => {
    it('should calculate advanced score with all factors', async () => {
      ...
      const result = await service.calculateAdvancedCreditScore('user-123', factors);
  ...
  describe('getCreditFactors', () => {
    ...
    it('should throw error for non-existent wallet', async () => {
      ...
      await expect(service.getCreditFactors('user-999')).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('getCreditReport', () => {
    ...
    it('should throw error for non-existent wallet', async () => {
      ...
      await expect(service.getCreditReport('user-999')).rejects.toThrow(NotFoundException);
    });
  });
});
