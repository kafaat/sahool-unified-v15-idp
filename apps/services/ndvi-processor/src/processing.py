...
def create_job(tenant_id: str, field_id: str, job_type: str, parameters: dict, priority: int = 5) -> str:
    """إنشاء مهمة معالجة"""
    job_id = str(uuid4())
...
def _generate_mock_timeseries(field_id: str, start_date: str, end_date: str) -> list[TimeseriesPoint]:
...
async def create_composite(
    ...
    # Persist via store (in-memory always; DB + NATS when configured)
