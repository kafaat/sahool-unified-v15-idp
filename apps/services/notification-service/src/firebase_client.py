...
class FirebaseClient:
    ...
    def subscribe_to_topic(self, tokens: Union[str, List[str]], topic: str) -> Dict[str, int]:
        """
    ...
    def unsubscribe_from_topic(self, tokens: Union[str, List[str]], topic: str) -> Dict[str, int]:
        """
