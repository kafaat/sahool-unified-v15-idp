...
def mock_farmer_profile():
    ...
    from src.main import FarmerProfile, Governorate, CropType, NotificationChannel
...
class TestNotificationCreation:
    ...
    async def test_create_notification_with_preferences(self, mock_notification):
        ...
        from src.main import create_notification, NotificationType, NotificationPriority

        with patch('src.repository.NotificationRepository.create',
                   new=AsyncMock(return_value=mock_notification)):
            with patch('src.preferences_service.PreferencesService.check_if_should_send',
                       new=AsyncMock(return_value=(True, ['push', 'sms']))):
                with patch('src.main.send_notification_via_channel', new=AsyncMock()):
    ...
    async def test_create_notification_multi_channel(self, mock_notification):
        ...
        with patch('src.repository.NotificationRepository.create',
            ...
            with patch('src.preferences_service.PreferencesService.check_if_should_send',
                ...
                with patch('src.main.send_notification_via_channel', new=AsyncMock()) as mock_send:
...
class TestNotificationDelivery:
    ...
    async def test_send_sms_notification_success(self, mock_notification):
        ...
        from src.main import send_sms_notification, FARMER_PROFILES
    ...
    async def test_send_email_notification_success(self, mock_notification):
        ...
        from src.main import send_email_notification, FARMER_PROFILES
    ...
    async def test_send_push_notification_success(self, mock_notification):
        ...
        from src.main import send_push_notification, FARMER_PROFILES
    ...
    async def test_send_notification_via_channel_dispatcher(self, mock_notification):
        ...
        from src.main import send_notification_via_channel, NotificationChannel
