...
class TestUssdActions:
    ...
    def test_ussd_actions_registry_complete(self):
        ...
        expected_actions = [
            "weather_today", "weather_3day", "weather_rain",
            "field_status", "field_ndvi", "field_alerts",
            "irr_today", "irr_moisture", "irr_start", "irr_stop",
            "alerts_unread", "alerts_critical",
            "price_wheat", "price_barley", "price_dates", "price_vegetables",
            "help_usage", "help_contact", "help_register",
        ]
