...
setup_logging("vegetation-analysis-service")
...
async def get_scheduler_logs(
    ...
    # `where` is a join of static SQL fragments that all use $N placeholders
    # (built above); user input enters only via `args` bound by asyncpg.
    count_sql = f"""
