...
class SentinelHubProvider(SatelliteProvider):
    ...
    # Configurable via env vars — defaults to Copernicus Data Space Ecosystem (CDSE)
    # For legacy Sentinel Hub override:
    ...
    def __init__(self):
        ...
        # Accept CDSE_* aliases so both variable naming conventions work
        self.client_id = os.getenv("SENTINEL_HUB_CLIENT_ID") or os.getenv("CDSE_CLIENT_ID")
        self.client_secret = os.getenv("SENTINEL_HUB_CLIENT_SECRET") or os.getenv("CDSE_CLIENT_SECRET")
