...
class TestBroadcastEndpoint:
    ...
    def test_broadcast_to_user(self, client, valid_jwt_token):
        ...
        request_data = {
            ...
            "message": {"type": "notification", "body": "Direct message"},
        }
    ...
    def test_broadcast_to_field(self, client, valid_jwt_token):
        ...
        request_data = {
            "field_id": "field-789",
            "tenant_id": "tenant-456",
            "message": {"type": "field_update", "body": "Irrigation completed"},
        }
    ...
    def test_broadcast_to_room(self, client, valid_jwt_token):
        ...
        request_data = {
            "room": "chat:general",
            "tenant_id": "tenant-456",
            "message": {"type": "chat_message", "body": "Hello everyone"},
        }
    ...
    def test_broadcast_tenant_mismatch(self, client, valid_jwt_token):
        ...
        request_data = {
            ...
            "message": {"type": "notification", "body": "Unauthorized"},
        }
    ...
    def test_broadcast_admin_cross_tenant(self, client, admin_jwt_token):
        ...
        request_data = {
            ...
            "message": {"type": "system_announcement", "body": "System maintenance"},
        }
