...
class TestWebSocketConnection:
    ...
    def test_websocket_connection_success(self, mock_validate, client):
        ...
        mock_validate.return_value = AsyncMock(return_value={
            "sub": "user_123",
    ...
    def test_websocket_connection_invalid_token(self, mock_validate, client):
        ...
        with pytest.raises(Exception):
            with client.websocket_connect("/ws?tenant_id=tenant_123&token=invalid_token"):
                pass
