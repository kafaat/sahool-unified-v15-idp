    ...
    test("should display report generator on field page", async ({ page }) => {
      ...
      if (await fieldCard.isVisible()) {
        ...
        const reportsBtn = page.locator(
          'button:has-text("التقارير"), button:has-text("Reports")',
        );
      ...
      if (await fieldCard.isVisible()) {
        ...
        if (await reportsBtn.isVisible()) {
          ...
          for (const type of reportTypes) {
            await expect(page.locator(`[data-value="${type}"]`)).toBeVisible();
          }
        }
      }
    });
    ...
    test("should display section checkboxes", async ({ page }) => {
      ...
      if (await fieldCard.isVisible()) {
        ...
        if (await reportsBtn.isVisible()) {
          ...
          await expect(page.locator("text=/NDVI|مؤشر الصحة/i")).toBeVisible();
        }
      }
    });
    ...
    test("should generate field report", async ({ page }) => {
      ...
      if (await fieldCard.isVisible()) {
        ...
        if (await reportsBtn.isVisible()) {
          ...
          const fieldReportBtn = page.locator(
            '[data-value="field"], button:has-text("تقرير حقل"), button:has-text("Field Report")',
          );
    ...
    test("should generate season report", async ({ page }) => {
      ...
      if (await fieldCard.isVisible()) {
        ...
        if (await reportsBtn.isVisible()) {
          ...
          const seasonReportBtn = page.locator(
            '[data-value="season"], button:has-text("تقرير موسم"), button:has-text("Season Report")',
          );
      ...
      if (await fieldCard.isVisible()) {
        ...
        if (await reportsBtn.isVisible()) {
          ...
          if (await generateBtn.isVisible()) {
            ...
            await expect(
              page.locator(
                'button:has-text("السابق"), button:has-text("Previous")',
              ),
            ).toBeVisible({ timeout: 10000 });
            await expect(
              page.locator(
      ...
      if (await fieldCard.isVisible()) {
        ...
        if (await reportsBtn.isVisible()) {
          ...
          if (await generateBtn.isVisible()) {
            ...
            await expect(page.locator("text=/صفحة|Page/i")).toBeVisible({
              timeout: 10000,
            });
          }
        }
        ...
        if (await reportsBtn.isVisible()) {
          ...
          if (await generateBtn.isVisible()) {
            ...
            const downloadBtn = page.locator(
              'button:has-text("تنزيل"), button:has-text("Download")',
            );
        ...
        if (await reportsBtn.isVisible()) {
          ...
          if (await generateBtn.isVisible()) {
            ...
            const shareBtn = page.locator(
              'button:has-text("مشاركة"), button:has-text("Share")',
            );
          ...
          if (await generateBtn.isVisible()) {
            ...
            if (await shareBtn.isVisible()) {
              ...
              const copyLinkBtn = page.locator(
                'button:has-text("نسخ الرابط"), button:has-text("Copy Link")',
              );
