  ...
  test.describe("VRA Panel", () => {
    ...
    test("should show VRA type selector with all options", async ({ page }) => {
      ...
      if (await fieldCard.isVisible()) {
        ...
        const vraTypeSelector = page.locator(
          '[data-testid="vra-type-selector"]',
        );
  ...
  test.describe("Prescription Generation", () => {
    test("should generate prescription map", async ({ page }) => {
      ...
      if (await fieldCard.isVisible()) {
        ...
        const generateBtn = page.locator(
          'button:has-text("توليد"), button:has-text("Generate")',
        );
    ...
    test("should display prescription results table", async ({ page }) => {
      ...
      if (await fieldCard.isVisible()) {
        ...
        const prescriptionTable = page.locator(
    ...
    test("should export prescription as GeoJSON", async ({ page }) => {
      ...
      if (await fieldCard.isVisible()) {
        ...
        if (await exportBtn.isVisible()) {
          ...
          const geojsonOption = page.locator(
            '[data-value="geojson"], button:has-text("GeoJSON")',
          );
      ...
      if (await fieldCard.isVisible()) {
        ...
        if (await exportBtn.isVisible()) {
          ...
          const csvOption = page.locator(
            '[data-value="csv"], button:has-text("CSV")',
          );
      ...
      if (await fieldCard.isVisible()) {
        ...
        if (await historyBtn.isVisible()) {
          ...
          const deleteBtn = page
            ...
            .first()
            .locator(
              'button:has-text("حذف"), button:has-text("Delete"), [data-testid="delete-btn"]',
            );
