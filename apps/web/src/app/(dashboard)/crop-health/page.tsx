...
export const metadata: Metadata = {
  ...
  description: 'صحة المحصول والتشخيص - Monitor crop health, diagnose diseases, and get AI-powered recommendations',
  keywords: ['crop health', 'صحة المحصول', 'plant diagnosis', 'disease detection', 'sahool'],
  openGraph: {
