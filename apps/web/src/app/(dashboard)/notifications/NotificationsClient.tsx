    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Notifications</p>
        </div>
      ...
      {isLoading && (
        <div className="flex items-center justify-center py-12">
          ...
          <span className="mr-3 text-gray-500">جاري تحميل الإشعارات...</span>
        </div>
      )}
      ...
      {isError && !isLoading && (
        <div className="bg-red-50 rounded-lg border border-red-200 p-6 text-center">
          ...
          <p className="text-red-700 font-medium">فشل في تحميل الإشعارات</p>
            ...
            filteredNotifications.map((notification) => (
              <div
                ...
                className={`bg-white rounded-lg border p-4 hover:shadow-sm transition-shadow cursor-pointer ${
                  !notification.read
                    ? "border-r-4 border-r-sahool-green-500 bg-sahool-green-50/30"
                    : ""
                }`}
                onClick={() => {
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap mb-1">
                      ...
                      {!notification.read && (
                        <span className="w-2 h-2 bg-sahool-green-500 rounded-full" />
                      )}
                    </div>
                  ...
                  {!notification.read && (
                    <button
                      ...
                      className="flex-shrink-0 p-1.5 text-gray-400 hover:text-sahool-green-600 rounded-lg hover:bg-sahool-green-50"
                      title="تحديد كمقروء"
                    >
