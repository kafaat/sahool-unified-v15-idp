  ...
  return (
    <div className="p-6 space-y-6 max-w-2xl">
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-2xl font-bold mb-4">{tCommon('appName')} - i18n Integration Example</h2>
        ...
        <div className="space-y-4">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700">
              <li>
                Locale Code: <code className="bg-gray-100 px-2 py-1 rounded">{locale}</code>
              </li>
              <li>
                Display Name:{' '}
                <code className="bg-gray-100 px-2 py-1 rounded">{localeDisplayName}</code>
              </li>
              <li>
                Direction: <code className="bg-gray-100 px-2 py-1 rounded">{direction}</code>
              </li>
            </ul>
          </section>
