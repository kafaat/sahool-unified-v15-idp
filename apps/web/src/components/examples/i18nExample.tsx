...
export function I18nExample() {
  ...
  const locale: Locale = locales.includes(localeStr as Locale)
    ? (localeStr as Locale)
    : "ar";
        ...
        <div className="space-y-4">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700">
              <li>
                Locale Code:{" "}
                <code className="bg-gray-100 px-2 py-1 rounded">{locale}</code>
              </li>
              <li>
                Display Name:{" "}
