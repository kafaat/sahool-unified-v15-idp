    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-3">
          ...
          <p className="text-2xl font-bold text-gray-900" dir="ltr">
            {Math.round(conditions.rainProbability)} <span className="text-sm font-normal">%</span>
          </p>
      ...
      {(conditions.cloudCover !== undefined || conditions.uvIndex !== undefined) && (
        <div className="flex gap-4 text-sm text-gray-600" dir="rtl">
          {conditions.cloudCover !== undefined && (
            <div>
              <span className="font-medium">الغطاء السحابي:</span> {Math.round(conditions.cloudCover)}%
            </div>
          )}
