...
export const WindowTimeline = React.memo<WindowTimelineProps>(
  ({ timeline, onBlockClick, showDetails = true, height = 200 }) => {
    ...
    const handleBlockKeyDown = (event: React.KeyboardEvent, block: TimelineBlock) => {
    ...
    if (blocks.length === 0) {
      return (
        ...
        >
          ...
          <p className="text-gray-600">لا توجد نوافذ متاحة</p>
            ...
            {blocks.map((block) => {
              ...
              return (
                <div
                  ...
                  onKeyDown={(e) => block.actionable && handleBlockKeyDown(e, block)}
                  className={`
