    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-semibold text-gray-900">{t('yieldAnalysis')}</h3>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                {isUnderperforming && <AlertTriangle className="w-5 h-5 text-red-500" />}
                {isOverperforming && <TrendingUp className="w-5 h-5 text-green-500" />}
              </div>
