...
export const communityApi = {
  ...
  createPost: async (data: Partial<Post>): Promise<Post> => {
    try {
      ...
      const errorMessage =
        axiosError.response?.data?.message || ERROR_MESSAGES.CREATE_POST_FAILED.en;
      const errorMessageAr =
        axiosError.response?.data?.message_ar || ERROR_MESSAGES.CREATE_POST_FAILED.ar;
  ...
  updatePost: async (id: string, data: Partial<Post>): Promise<Post> => {
    try {
      const response = await api.put(
        buildUrl(COMMUNITY_ENDPOINTS.POST_UPDATE, { postId: id }),
        data
      );
      const post = response.data.data || response.data;
      return post;
      ...
      const errorMessage =
        axiosError.response?.data?.message || ERROR_MESSAGES.UPDATE_POST_FAILED.en;
      const errorMessageAr =
        axiosError.response?.data?.message_ar || ERROR_MESSAGES.UPDATE_POST_FAILED.ar;
  ...
  deletePost: async (id: string): Promise<void> => {
    try {
      ...
      const errorMessage =
        axiosError.response?.data?.message || ERROR_MESSAGES.DELETE_POST_FAILED.en;
      const errorMessageAr =
        axiosError.response?.data?.message_ar || ERROR_MESSAGES.DELETE_POST_FAILED.ar;
  ...
  addComment: async (postId: string, content: string, parentId?: string): Promise<Comment> => {
    try {
      ...
      const errorMessage =
        axiosError.response?.data?.message || ERROR_MESSAGES.CREATE_COMMENT_FAILED.en;
      const errorMessageAr =
        axiosError.response?.data?.message_ar || ERROR_MESSAGES.CREATE_COMMENT_FAILED.ar;
  ...
  joinGroup: async (groupId: string): Promise<void> => {
    try {
      ...
      const errorMessage =
        axiosError.response?.data?.message || ERROR_MESSAGES.JOIN_GROUP_FAILED.en;
      const errorMessageAr =
        axiosError.response?.data?.message_ar || ERROR_MESSAGES.JOIN_GROUP_FAILED.ar;
  ...
  leaveGroup: async (groupId: string): Promise<void> => {
    try {
      ...
      const errorMessage =
        axiosError.response?.data?.message || ERROR_MESSAGES.LEAVE_GROUP_FAILED.en;
      const errorMessageAr =
        axiosError.response?.data?.message_ar || ERROR_MESSAGES.LEAVE_GROUP_FAILED.ar;
  ...
  sendMessage: async (
    ...
    try {
      ...
      const errorMessage =
        axiosError.response?.data?.message || ERROR_MESSAGES.SEND_MESSAGE_FAILED.en;
      const errorMessageAr =
        axiosError.response?.data?.message_ar || ERROR_MESSAGES.SEND_MESSAGE_FAILED.ar;
  ...
  askExpert: async (data: Partial<ExpertQuestion>): Promise<ExpertQuestion> => {
    try {
      ...
      const errorMessage =
        axiosError.response?.data?.message || ERROR_MESSAGES.ASK_EXPERT_FAILED.en;
      const errorMessageAr =
        axiosError.response?.data?.message_ar || ERROR_MESSAGES.ASK_EXPERT_FAILED.ar;
