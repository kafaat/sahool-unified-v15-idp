...
// FarmBoundaryMap - Interactive boundary drawing for farm creation
// خريطة رسم حدود المزرعة التفاعلية
// Supports: polygon (click-to-add vertices) + rectangle (two-click drag)
// Based on FieldBoundaryMap - emits only bbox (no GeoJSON)
...
export default function FarmBoundaryMap({
  ...
  const handleAddVertex = useCallback(
    ...
    [mode, completed, vertices, onBboxChange]
  );
