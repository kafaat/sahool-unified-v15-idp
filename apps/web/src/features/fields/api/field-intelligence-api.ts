...
export async function fetchLivingFieldScore(
  ...
  try {
    ...
    return {
      success: false,
      error:
        error instanceof Error ? error.message : INTELLIGENCE_ERROR_MESSAGES.SCORE_FETCH_FAILED.en,
      error_ar: INTELLIGENCE_ERROR_MESSAGES.SCORE_FETCH_FAILED.ar,
    };
  }
}
 ...
 */
export async function fetchFieldZones(fieldId: string): Promise<ApiResponse<FieldZone[]>> {
  if (!fieldId || typeof fieldId !== 'string' || fieldId.trim().length === 0) {
    return {
      success: false,
      error: INTELLIGENCE_ERROR_MESSAGES.INVALID_FIELD_ID.en,
  ...
  try {
    ...
    return {
      success: false,
      error:
        error instanceof Error ? error.message : INTELLIGENCE_ERROR_MESSAGES.ZONES_FETCH_FAILED.en,
      error_ar: INTELLIGENCE_ERROR_MESSAGES.ZONES_FETCH_FAILED.ar,
    };
  }
}
 ...
 */
export async function fetchFieldAlerts(fieldId: string): Promise<ApiResponse<FieldAlert[]>> {
  if (!fieldId || typeof fieldId !== 'string' || fieldId.trim().length === 0) {
    return {
      success: false,
      error: INTELLIGENCE_ERROR_MESSAGES.INVALID_FIELD_ID.en,
  ...
  try {
    ...
    return {
      success: false,
      error:
        error instanceof Error ? error.message : INTELLIGENCE_ERROR_MESSAGES.ALERTS_FETCH_FAILED.en,
      error_ar: INTELLIGENCE_ERROR_MESSAGES.ALERTS_FETCH_FAILED.ar,
    };
  }
}
...
export async function createTaskFromAlert(
  ...
  try {
    ...
    return {
      success: false,
      error:
        error instanceof Error ? error.message : INTELLIGENCE_ERROR_MESSAGES.TASK_CREATE_FAILED.en,
      error_ar: INTELLIGENCE_ERROR_MESSAGES.TASK_CREATE_FAILED.ar,
    };
  }
}
