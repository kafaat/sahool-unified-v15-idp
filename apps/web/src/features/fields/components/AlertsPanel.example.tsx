...
const mockAlerts: FieldAlert[] = [
  {
    ...
    message: 'تم رصد انخفاض بنسبة 25% في مؤشر NDVI خلال الأسبوع الماضي. قد يشير ذلك إلى مشكلة في صحة المحصول.',
    data: {
      current_value: 0.45,
      previous_value: 0.60,
      drop_percentage: 25,
  ...
  },
  {
    ...
    message: 'من المتوقع انخفاض درجات الحرارة إلى ما دون الصفر خلال الليلة القادمة. يُنصح باتخاذ إجراءات وقائية.',
    data: {
      expected_temp: '-2°C',
      probability: '85%',
  ...
  },
  {
    ...
    message: 'مستوى رطوبة التربة أقل من المستوى الموصى به. يُنصح بالري في أقرب وقت ممكن.',
    data: {
      current_moisture: '15%',
      optimal_range: '25-35%',
  ...
  },
  {
    ...
    message: 'مهمة "تسميد القمح - المرحلة الثانية" متأخرة بثلاثة أيام. يجب إتمامها في أقرب وقت.',
    data: {
      task_id: 'task-567',
  ...
  },
  {
    ...
    message: 'من المتوقع هطول أمطار خفيفة خلال 24 ساعة القادمة. قد تساعد في تحسين رطوبة التربة.',
    data: {
