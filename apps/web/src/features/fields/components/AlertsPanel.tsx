        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-2 mb-1">
              <h4 className="font-semibold text-gray-900 leading-tight">{alert.title}</h4>
        ...
        <div className="border-t border-gray-200 bg-gray-50">
          ...
          {Object.keys(alert.data).length > 0 && (
            <div className="p-4 border-b border-gray-200 bg-white">
              <h5 className="font-medium text-gray-900 mb-3 text-sm">تفاصيل التنبيه</h5>
          ...
          <div className="p-4 flex items-center justify-end gap-2">
            ...
            <Button variant="outline" size="sm" onClick={onCreateTask} className="gap-2">
...
export const AlertsPanel: React.FC<AlertsPanelProps> = ({
  ...
  const handleWebSocketMessage = useCallback(
    (message: any) => {
      if (message.type === 'field_alert' && message.fieldId === fieldId) {
        ...
        setAlerts((prev) =>
          prev.map((alert) =>
            alert.id === message.alertId ? { ...alert, acknowledged: true } : alert
          )
        );
      }
    },
  ...
  const getTaskFormDataFromAlert = useCallback((alert: FieldAlert): Partial<TaskFormData> => {
  ...
  const stats = useMemo(() => {
    return {
      ...
      byType: {
        ...
        weather_warning: alerts.filter((a) => a.type === 'weather_warning' && !a.acknowledged)
          .length,
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    {stats.active > 0 ? `${stats.active} تنبيه نشط` : 'لا توجد تنبيهات نشطة'}
                    {stats.critical > 0 && (
            ...
            <Card variant="bordered" padding="lg">
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">
                  {showAcknowledged ? 'جميع التنبيهات تم الاطلاع عليها' : 'حقلك في حالة جيدة'}
                </p>
              </div>
            </Card>
          )}
