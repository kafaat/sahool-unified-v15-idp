  ...
  return (
    <div className="space-y-4">
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">خريطة الحقول التفاعلية الكاملة</h2>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        {selectedField ? (
          ...
          <p className="text-gray-500 text-sm">انقر على حقل أو مهمة على الخريطة لعرض التفاصيل</p>
        )}
      </div>
    </div>
  );
