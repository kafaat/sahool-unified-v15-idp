...
export function WithFieldNameExample() {
  return (
    <div className="max-w-2xl mx-auto p-6">
      <LivingFieldCard fieldId="field-456" fieldName="North Field" fieldNameAr="الحقل الشمالي" />
    </div>
  );
}
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">لوحة التحكم - الحقل</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg border-2 border-gray-200 p-6">
              <h3 className="font-semibold text-gray-900 mb-2">المعلومات الإضافية</h3>
              <p className="text-sm text-gray-600">Additional field information and controls...</p>
            </div>
          </div>
        </div>
      </div>
