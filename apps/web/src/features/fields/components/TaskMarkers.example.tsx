...
export function TaskMapWithoutClusteringExample() {
  ...
  return (
    <div className="h-96">
      ...
      <TaskMarkers tasks={tasks} fields={fields} mapRef={mapRef} enableClustering={false} />
    </div>
  );
}
...
export function TaskMapWithCustomClickExample() {
  ...
  return (
    <div className="h-96">
      <div ref={mapContainerRef} className="h-full w-full" />
      <TaskMarkers tasks={tasks} fields={fields} mapRef={mapRef} onTaskClick={handleTaskClick} />
    </div>
  );
}
