...
const getWeatherIcon = (condition?: string, size: number = 24) => {
  if (!condition) return <Cloud className={`w-${size} h-${size}`} aria-hidden="true" />;
  ...
  if (lower.includes('clear') || lower.includes('sunny') || lower.includes('صافي') || lower.includes('مشمس')) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        {/* Temperature */}
        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3" dir="rtl">
      ...
      {weather.location && (
        <div
          className="text-center pt-3 border-t border-white/20"
          dir="rtl"
        >
    ...
    return (
      ...
      >
        <div className="bg-gradient-to-br from-blue-500/90 to-cyan-600/90 backdrop-blur-md rounded-lg shadow-lg p-4 min-w-[200px]">
          <div className="animate-pulse text-white text-sm text-center" dir="rtl">
            جاري تحميل الطقس...
          </div>
        </div>
      </div>
    ...
    return (
      ...
      >
        <div className="bg-gradient-to-br from-gray-500/90 to-gray-600/90 backdrop-blur-md rounded-lg shadow-lg p-4 min-w-[200px]">
          <div className="flex items-center gap-2 text-white text-sm" dir="rtl">
