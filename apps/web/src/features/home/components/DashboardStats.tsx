...
const StatCard: React.FC<StatCardProps> = ({ icon, label, labelAr, value, trend, color }) => {
  return (
    <div className={`p-6 rounded-xl border-2 ${color} bg-white hover:shadow-lg transition-shadow`}>
