...
const MOCK_REPORT_TEMPLATES: ReportTemplate[] = [
  {
    ...
    description:
      "Comprehensive field performance analysis with NDVI trends and health metrics",
  ...
  },
  {
    ...
    description:
      "Complete season analysis with yield estimates and cost breakdown",
...
export const reportsApi = {
   ...
   * إنشاء تقرير حقل
   */
  generateFieldReport: async (
    request: GenerateFieldReportRequest,
   ...
   * إنشاء تقرير موسم
   */
  generateSeasonReport: async (
    request: GenerateSeasonReportRequest,
  ): Promise<GeneratedReport> => {
    try {
      const response = await api.post(
  ...
  getReportHistory: async (
    ...
    try {
      ...
      return [
        MOCK_FIELD_REPORT,
        { ...MOCK_FIELD_REPORT, id: "report-field-2", downloadCount: 5 },
      ];
    }
  },
