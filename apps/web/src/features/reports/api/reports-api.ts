...
export const reportsApi = {
  ...
  generateFieldReport: async (request: GenerateFieldReportRequest): Promise<GeneratedReport> => {
    try {
      const response = await api.post(`${API_PREFIX}/reports/field/generate`, request);
  ...
  generateSeasonReport: async (request: GenerateSeasonReportRequest): Promise<GeneratedReport> => {
    try {
      const response = await api.post(`${API_PREFIX}/reports/season/generate`, request);
      const data = response.data.data || response.data;
      return data;
    } catch (error) {
  ...
  getReportHistory: async (filters?: ReportHistoryFilters): Promise<ReportHistoryItem[]> => {
    try {
      ...
      const response = await api.get(`${API_PREFIX}/reports/history?${params.toString()}`);
      const data = response.data.data || response.data;
  ...
  shareReport: async (request: ShareReportRequest): Promise<ShareReportResponse> => {
    try {
      const response = await api.post(`${API_PREFIX}/reports/${request.reportId}/share`, request);
      const data = response.data.data || response.data;
      return {
        success: true,
  ...
  getFieldReportData: async (
    ...
    try {
      ...
      const response = await api.get(`${API_PREFIX}/reports/field/data?${params.toString()}`);
      const data = response.data.data || response.data;
      return data;
    } catch (error) {
  ...
  getSeasonReportData: async (
    ...
    try {
      ...
      const response = await api.get(`${API_PREFIX}/reports/season/data?${params.toString()}`);
      const data = response.data.data || response.data;
      return data;
    } catch (error) {
