...
export const FieldReportTemplate: React.FC<FieldReportTemplateProps> = ({
  ...
  const BilingualText = ({ en, ar }: { en: string; ar: string }) => {
    ...
    return (
      <div className="space-y-1">
        <div className="text-right">{ar}</div>
  ...
  return (
    <div
      ...
      dir={isRTL ? 'rtl' : 'ltr'}
      style={{
        fontFamily: isRTL ? 'Tajawal, Noto Sans Arabic, sans-serif' : 'Inter, Arial, sans-serif',
      }}
    >
      {/* Header */}
      <div className="border-b-4 border-green-500 pb-6 mb-8 print:mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                {showBoth ? (
                  <>
                    <div className="text-right">{titleAr || 'تقرير أداء الحقل'}</div>
        ...
        <div className="bg-green-50 rounded-lg p-4 mt-4">
          <h2 className="text-2xl font-bold text-green-900">
            {showBoth ? (
              <>
                <div className="text-right">{data.field.nameAr}</div>
      ...
      <div className="mt-12 pt-6 border-t border-gray-200 text-center text-sm text-gray-600">
        <div className="flex items-center justify-between">
          ...
          <div>
            <BilingualText en="Generated by SAHOOL Platform" ar="تم إنشاؤه بواسطة منصة ساهول" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="mb-8 print:mb-6 print:break-inside-avoid">
      <h3 className="text-xl font-bold text-green-600 mb-4 pb-2 border-b-2 border-gray-200">
        {language === 'both' && titleAr ? (
          <>
            <div className="text-right">{titleAr}</div>
    ...
    <div className="bg-gray-50 rounded-lg p-4">
      <div className="flex items-center gap-2 mb-2">
        ...
        <div className="text-sm font-medium text-gray-600">
          {language === 'ar' ? (
            ...
            <>
              <div className="text-right">{label.ar}</div>
      ...
      <div className="text-lg font-semibold text-gray-900">
        {language === 'ar' ? (
          ...
          <>
            <div className="text-right">{value.ar}</div>
