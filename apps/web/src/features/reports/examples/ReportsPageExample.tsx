...
import { ReportGenerator, ReportPreview, ReportHistory, FieldReportTemplate } from '../components';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mt-8 bg-blue-50 rounded-xl border border-blue-200 p-6">
          <h3 className="text-lg font-semibold text-blue-900 mb-3">كيفية استخدام التقارير</h3>
  ...
  return (
    <button
      ...
      className={`flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all ${
        active ? 'bg-green-500 text-white shadow-md' : 'bg-gray-50 text-gray-700 hover:bg-gray-100'
      }`}
    >
      {icon}
