...
const MOCK_TRIALS: ResearchTrial[] = [
  {
    id: "1",
    title: "Wheat Variety Comparison Trial",
    titleAr: "تجربة مقارنة أصناف القمح",
    ...
    fieldId: "field-1",
    fieldName: "North Research Field",
    cropType: "wheat",
  ...
  {
    id: "2",
    title: "Smart Irrigation Efficiency Study",
    titleAr: "دراسة كفاءة الري الذكي",
  ...
  {
    id: "3",
    title: "Organic Fertilizer Impact Assessment",
    titleAr: "تقييم تأثير الأسمدة العضوية",
