    ...
    subcategories: [
      {
        ...
        descriptionAr: "حشرات صغيرة ماصة",
      },
      {
        value: "caterpillar",
        label: "Caterpillars",
        labelAr: "دودة",
        description: "Larvae on leaves",
        descriptionAr: "يرقات على الأوراق",
      },
      {
        value: "locust",
        label: "Locust",
        labelAr: "جراد",
        description: "Desert locust",
        descriptionAr: "جراد صحراوي",
      },
      {
        value: "whitefly",
        label: "Whitefly",
        labelAr: "ذبابة بيضاء",
        description: "White flying insects",
        descriptionAr: "حشرات بيضاء طائرة",
      },
      {
        value: "other_pest",
        label: "Other",
        labelAr: "أخرى",
        description: "Other pests",
        descriptionAr: "حشرات أخرى",
      },
    ],
  },
  {
    ...
    subcategories: [
      {
        ...
        label: "Rust",
        labelAr: "صدأ",
        description: "Orange/brown spots",
        descriptionAr: "بقع برتقالية/بنية",
      },
      {
        value: "powdery_mildew",
        label: "Powdery Mildew",
        labelAr: "بياض دقيقي",
        description: "White powdery layer",
        descriptionAr: "طبقة بيضاء",
      },
      {
        value: "blight",
        label: "Blight",
        labelAr: "لفحة",
        description: "Rapid browning/death",
        descriptionAr: "احمرار/موت سريع",
      },
      {
        value: "rot",
        label: "Rot",
        labelAr: "تعفن",
        description: "Root/stem rot",
        descriptionAr: "تعفن الجذور/الساق",
      },
      {
        value: "other_disease",
        label: "Other",
    ...
    subcategories: [
      {
        value: "broadleaf",
        label: "Broadleaf",
        labelAr: "عريضة الأوراق",
        description: "Broadleaf weeds",
        descriptionAr: "أعشاب عريضة الأوراق",
      },
      {
        value: "grassy",
        label: "Grassy",
        labelAr: "نجيلية",
        description: "Grass-like weeds",
        descriptionAr: "أعشاب نجيلية",
      },
      {
        value: "sedge",
        label: "Sedge",
        labelAr: "سعدية",
        description: "Sedge weeds",
        descriptionAr: "أعشاب سعدية",
      },
      {
        value: "other_weed",
        label: "Other",
        labelAr: "أخرى",
        description: "Other weeds",
        descriptionAr: "أعشاب أخرى",
      },
    ],
  },
  {
    ...
    subcategories: [
      {
        ...
        label: "Nitrogen",
        labelAr: "نيتروجين",
        description: "General yellowing",
        descriptionAr: "اصفرار عام",
      },
      {
        value: "phosphorus",
        label: "Phosphorus",
        labelAr: "فسفور",
        description: "Purple/dark leaves",
        descriptionAr: "أوراق بنفسجية/داكنة",
      },
      {
        value: "potassium",
        label: "Potassium",
        labelAr: "بوتاسيوم",
        description: "Brown edges",
        descriptionAr: "حواف بنية",
      },
      {
        value: "iron",
        label: "Iron",
        ...
        descriptionAr: "اصفرار بين العروق",
      },
      {
        value: "other_nutrient",
        label: "Other",
        labelAr: "أخرى",
        description: "Other deficiencies",
    ...
    subcategories: [
      {
        ...
        descriptionAr: "أوراق ذابلة",
      },
      {
        value: "overwatering",
        label: "Overwatering",
        labelAr: "ري زائد",
        description: "Waterlogged soil",
        descriptionAr: "تربة مشبعة بالماء",
      },
      {
        value: "irrigation_issue",
        label: "Irrigation Issue",
        labelAr: "مشكلة ري",
        description: "Irrigation system problem",
        descriptionAr: "مشكلة في نظام الري",
      },
      {
        value: "other_water",
        label: "Other",
        labelAr: "أخرى",
        description: "Other water issues",
        descriptionAr: "مشاكل مياه أخرى",
      },
    ],
  },
  {
    ...
    subcategories: [
      {
        ...
        labelAr: "ضرر ميكانيكي",
        description: "Equipment/animal damage",
        descriptionAr: "ضرر من المعدات/الحيوانات",
      },
      {
        value: "weather_damage",
        label: "Weather Damage",
        labelAr: "ضرر جوي",
        description: "Hail/wind/frost damage",
        descriptionAr: "ضرر من البرد/الرياح/الصقيع",
      },
      {
        value: "soil_issue",
        label: "Soil Issue",
        labelAr: "مشكلة تربة",
        description: "Soil compaction/salinity",
        descriptionAr: "انضغاط/ملوحة التربة",
      },
      {
        value: "other_other",
        label: "Other",
