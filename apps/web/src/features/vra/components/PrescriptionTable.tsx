            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b-2 border-gray-300">
                  <th className="text-left p-3 text-sm font-semibold">Zone | منطقة</th>
                  <th className="text-left p-3 text-sm font-semibold">Level | مستوى</th>
                  <th className="text-right p-3 text-sm font-semibold">NDVI Range | نطاق NDVI</th>
                  <th className="text-right p-3 text-sm font-semibold">Area | المساحة (ha)</th>
                  <th className="text-right p-3 text-sm font-semibold">% of Field | % من الحقل</th>
                  <th className="text-right p-3 text-sm font-semibold">Rate | المعدل</th>
