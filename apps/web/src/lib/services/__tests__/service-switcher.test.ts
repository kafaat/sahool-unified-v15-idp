...
describe('Service Switcher', () => {
  ...
  describe('Service URL Generation', () => {
    ...
    it('should generate correct URL for legacy service', () => {
      mockStorage.setItem('sahool_service_versions', JSON.stringify({ weather: 'legacy' }));
      mockStorage.setItem.mockClear();
    ...
    it('should generate correct URL for mock service', () => {
      mockStorage.setItem('sahool_service_versions', JSON.stringify({ weather: 'mock' }));
      mockStorage.setItem.mockClear();
    ...
    it('should fallback to modern when legacy is not available', () => {
      mockStorage.setItem('sahool_service_versions', JSON.stringify({ irrigation: 'legacy' }));
      mockStorage.setItem.mockClear();
