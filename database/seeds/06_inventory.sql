...
(
    ...
    'Red Sea Agricultural Import/Export',
    'شركة البحر الأحمر للاستيراد والتصدير الزراعي',
...
VALUES
(
    'i1111111-0001-0001-0001-000000000001',
    'SEED-WHEAT-001',
    'Wheat Seeds - Improved Variety',
    'بذور قمح - صنف محسن',
    'SEED',
    'Cereals',
    'KG',
...
(
    'i1111111-0001-0001-0001-000000000002',
    'SEED-BARLEY-001',
    'Barley Seeds - Drought Resistant',
    'بذور شعير - مقاوم للجفاف',
    'SEED',
    'Cereals',
    'KG',
    1.0,
...
(
    'i1111111-0001-0001-0001-000000000003',
    'SEED-SORGHUM-001',
    'Sorghum Seeds (Dhurra)',
    'بذور ذرة رفيعة',
    'SEED',
    'Cereals',
    'KG',
...
(
    'i1111111-0001-0001-0001-000000000004',
    'SEED-CORN-001',
    'Hybrid Maize Seeds',
    'بذور ذرة شامية هجين',
    'SEED',
...
(
    'i1111111-0001-0001-0001-000000000005',
    'SEED-TOMATO-001',
    'Tomato Seeds - Heat Tolerant',
    'بذور طماطم - تتحمل الحرارة',
    'SEED',
    'Vegetables',
    'GRAM',
    100.0,
...
(
    'i1111111-0001-0001-0001-000000000006',
    'SEED-ONION-001',
    'Red Onion Seeds',
    'بذور بصل أحمر',
    'SEED',
...
(
    'i1111111-0001-0001-0001-000000000007',
    'SEED-POTATO-001',
    'Potato Seed Tubers',
    'درنات بذور البطاطس',
    'SEED',
...
(
    'i1111111-0001-0001-0001-000000000008',
    'SEED-CUCUMBER-001',
    'Cucumber Seeds - F1 Hybrid',
    'بذور خيار - هجين من الجيل الأول',
    'SEED',
    'Vegetables',
    'GRAM',
    50.0,
...
(
    'i1111111-0001-0001-0001-000000000009',
    'SEED-COFFEE-001',
...
(
    'i1111111-0001-0001-0001-000000000010',
    'SEED-DATE-001',
    'Date Palm Offshoots',
    'فسائل نخيل التمر',
    'SEED',
...
VALUES
(
    'i2222222-0001-0001-0001-000000000001',
    'FERT-NPK-001',
...
(
    'i2222222-0001-0001-0001-000000000002',
    'FERT-UREA-001',
    'Urea Fertilizer 46% N',
    'سماد يوريا 46% نيتروجين',
    'FERTILIZER',
    'Nitrogen',
    'BAG',
    50.0,
...
(
    'i2222222-0001-0001-0001-000000000003',
    'FERT-DAP-001',
...
(
    'i2222222-0001-0001-0001-000000000004',
    'FERT-COMPOST-001',
    'Organic Compost',
    'سماد عضوي',
    'FERTILIZER',
...
(
    'i2222222-0001-0001-0001-000000000005',
    'FERT-MICRO-001',
    'Micronutrient Mix',
    'خليط العناصر الصغرى',
    'FERTILIZER',
...
(
    'i2222222-0001-0001-0001-000000000006',
    'FERT-LIQUID-001',
...
VALUES
(
    'i3333333-0001-0001-0001-000000000001',
    'PEST-INSECT-001',
    'Malathion Insecticide 50% EC',
    'مبيد حشري ملاثيون 50%',
    'PESTICIDE',
    'Insecticide',
    'LITER',
    1.0,
...
(
    'i3333333-0001-0001-0001-000000000002',
    'PEST-FUNGI-001',
    'Copper Fungicide',
    'مبيد فطري نحاسي',
    'PESTICIDE',
...
(
    'i3333333-0001-0001-0001-000000000003',
    'PEST-HERB-001',
...
(
    'i3333333-0001-0001-0001-000000000004',
    'PEST-BIO-001',
...
(
    'i3333333-0001-0001-0001-000000000005',
    'PEST-MITE-001',
    'Acaricide for Mites',
    'مبيد العناكب',
    'PESTICIDE',
...
VALUES
(
    'i4444444-0001-0001-0001-000000000001',
    'TOOL-HOE-001',
    'Agricultural Hoe',
    'معول زراعي',
    'TOOL',
...
(
    'i4444444-0001-0001-0001-000000000002',
    'TOOL-SPRAYER-001',
    'Backpack Sprayer 16L',
    'رشاش ظهري 16 لتر',
    'TOOL',
    'Sprayers',
    'PIECE',
...
(
    'i4444444-0001-0001-0001-000000000003',
    'TOOL-PRUNER-001',
    'Pruning Shears',
    'مقص تقليم',
    'TOOL',
...
(
    'i4444444-0001-0001-0001-000000000004',
    'EQUIP-PUMP-001',
    'Water Pump 2HP',
    'مضخة ماء 2 حصان',
    'EQUIPMENT_PART',
...
VALUES
(
    'i5555555-0001-0001-0001-000000000001',
    'IRRIG-DRIP-001',
    'Drip Irrigation Tape 16mm',
    'شريط تنقيط 16 ملم',
    'IRRIGATION_SUPPLY',
    'Drip Systems',
    'ROLL',
...
(
    'i5555555-0001-0001-0001-000000000002',
    'IRRIG-PIPE-001',
    'PVC Pipe 3 inch',
    'أنابيب PVC 3 بوصة',
    'IRRIGATION_SUPPLY',
...
(
    'i5555555-0001-0001-0001-000000000003',
    'IRRIG-EMITTER-001',
    'Drip Emitters 4L/hr',
    'منقطات 4 لتر/ساعة',
    'IRRIGATION_SUPPLY',
...
(
    'i5555555-0001-0001-0001-000000000004',
    'IRRIG-SPRINK-001',
    'Sprinkler Heads',
    'رؤوس رشاشات',
    'IRRIGATION_SUPPLY',
...
INSERT INTO stock_movements (
    item_id, movement_type, quantity, previous_qty, new_qty, unit_cost, total_cost, reference_type, notes
)
VALUES
(
    'i1111111-0001-0001-0001-000000000001',
...
UPDATE inventory_items SET last_restocked = now() - INTERVAL '30 days'
...
SELECT
    ...
    (
        ...
        WHERE id = inventory_items.supplier_id
    ) AS supplier
...
FROM suppliers AS s
LEFT JOIN inventory_items AS i ON s.id = i.supplier_id
