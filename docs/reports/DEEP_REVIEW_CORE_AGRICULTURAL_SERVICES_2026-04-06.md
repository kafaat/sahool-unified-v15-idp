...
| الفئة | مؤكّد | مُصحَّح جزئياً | غير دقيق | جديد (مكتشف) | المجموع |
|-------|-------|---------------|----------|-------------|---------|
| P0 — تعطّل كامل | 3 | 1 | 0 | 2 | **6** |
| P1 — ضرر وظيفي | 2 | 0 | 1 | 4 | **7** |
| P2 — تحسين | 0 | 0 | 0 | 3 | **3** |

> **ملاحظة**: P0-1 (AUTH_SECRET_KEY) كان مُصحَّحاً جزئياً في فرع الإصلاح (2 من 9 خدمات). P0-2/3/4 مؤكّدة ومُصلحة بالكامل. P0-5/6 مكتشفة حديثاً.
