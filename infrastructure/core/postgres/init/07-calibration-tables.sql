-- ============================================================================
-- 07-calibration-tables.sql
-- Calibration Engine persistence layer (used by crop-intelligence-service)
-- محرك المعايرة - طبقة الثبات
-- Source: shared/calibration/migrations/s16_010_calibration_tables.sql
-- ============================================================================
