...
INSERT INTO satellite_providers (name, name_ar, provider_type, priority, base_url, auth_type, resolution_m, revisit_days, satellites, indices, free_tier, quota_monthly, processing_units_monthly)
VALUES
    ...
    ('esri_satellite', 'إسري', 'map_tiles', 20, 'https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer', 'none', NULL, NULL,
     NULL, NULL, TRUE, NULL, NULL)
