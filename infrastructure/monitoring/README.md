...
> (envsubst wrapper, init container, or Helm/kustomize overlay).
>
> The other variables on this page (`GRAFANA_*`, `POSTGRES_*`, etc.) ARE
> consumed directly by the compose stack and do work as written.
