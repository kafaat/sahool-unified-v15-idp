...
export class GrowthSimulationController {
  ...
  @ApiBody({
    ...
    schema: {
      ...
      properties: {
        ...
        sowingDate: { type: 'string', example: '2024-11-15', description: 'Sowing date (YYYY-MM-DD)' },
        fieldLocation: {
          type: 'object',
          properties: {
  ...
  @ApiQuery({ name: 'cropType', required: false, example: 'WHEAT', description: 'Crop type' })
  @ApiQuery({ name: 'sowingDate', required: false, example: '2024-11-15', description: 'Sowing date' })
  @ApiQuery({ name: 'days', required: false, example: 180, description: 'Simulation days' })
  @ApiQuery({ name: 'climate', required: false, example: 'temperate', description: 'Climate type' })
  ...
  @ApiBody({
    ...
    schema: {
      ...
      properties: {
        ...
        avgTemperature: { type: 'number', example: 25, description: 'Average temperature (°C)' },
        avgRadiation: { type: 'number', example: 18, description: 'Average radiation (MJ m⁻² day⁻¹)' },
        seasonLength: { type: 'number', example: 120, description: 'Growing season length (days)' },
      },
  ...
  @ApiQuery({ name: 'startDate', required: false, example: '2024-11-15', description: 'Start date' })
  @ApiQuery({ name: 'days', required: false, example: 30, description: 'Number of days' })
  @ApiQuery({ name: 'climate', required: false, example: 'tropical', description: 'Climate type' })
