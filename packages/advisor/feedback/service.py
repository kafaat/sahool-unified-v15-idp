...
class FeedbackService:
    ...
    def get_feedback_stats(self, tenant_id: str) -> dict:
        ...
        helpful_count = sum(1 for f in feedback_list if f.feedback_type == FeedbackType.HELPFUL)
        applied_count = sum(1 for f in feedback_list if f.feedback_type == FeedbackType.APPLIED)
