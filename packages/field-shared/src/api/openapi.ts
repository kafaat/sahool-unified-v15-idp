...
- Premium: 120 requests/minute
  ...
  tags: [
    ...
    },
    {
      name: "Pests",
      description:
        "Pest management and treatment tracking - إدارة الآفات والعلاجات",
    },
    {
      name: "Health",
  ...
  paths: {
    ...
    "/pests/incidents": {
      get: {
        ...
        description:
          "Get paginated list of pest incidents - قائمة حوادث الآفات",
    ...
    "/pests/incidents/{id}": {
      get: {
        ...
        description:
          "Get pest incident details with treatments - تفاصيل حادثة الآفة",
    ...
    "/pests/treatments": {
      get: {
        ...
        description:
          "Get paginated list of pest treatments - قائمة علاجات الآفات",
      ...
      post: {
        ...
        description:
          "Record a new pest treatment application - تسجيل علاج الآفة",
    ...
    "/pests/incidents/{incidentId}/treatments": {
      get: {
        ...
        description:
          "Get all treatments for a specific incident - علاجات حادثة معينة",
      ...
      PestTreatment: {
        ...
        properties: {
          ...
          effectiveness: {
            ...
            nullable: true,
            description:
              "Treatment effectiveness from 1 (ineffective) to 5 (very effective)",
          },
