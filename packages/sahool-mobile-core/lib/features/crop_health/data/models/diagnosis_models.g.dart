...
Map<String, dynamic> _$$DiagnosisResultImplToJson(
    ...
    <String, dynamic>{
      ...
      if (instance.growthStage case final value?) 'growthStage': value,
      ...
      if (instance.expertReviewReason case final value?)
        'expertReviewReason': value,
      if (instance.weatherConsideration case final value?)
        'weatherConsideration': value,
...
Map<String, dynamic> _$$ExpertReviewRequestImplToJson(
    ...
    <String, dynamic>{
      'diagnosisId': instance.diagnosisId,
      if (instance.farmerNotes case final value?) 'farmerNotes': value,
...
Map<String, dynamic> _$$BatchDiagnosisResultImplToJson(
    ...
    <String, dynamic>{
      ...
      if (instance.fieldId case final value?) 'fieldId': value,
