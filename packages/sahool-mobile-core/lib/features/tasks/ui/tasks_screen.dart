      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            const _DetailRow(icon: Icons.schedule, label: 'الوقت', value: '08:00 ص - 10:00 ص'),
            const _DetailRow(icon: Icons.person, label: 'المسؤول', value: 'أحمد محمد'),
            const _DetailRow(icon: Icons.location_on, label: 'الموقع', value: 'الحقل الشمالي - القطاع C'),
            const _DetailRow(icon: Icons.water, label: 'كمية المياه', value: '500 م³'),
            const Spacer(),
            Row(
              children: [
                Expanded(
