...
const PII_PATTERNS: Record<PIIType, RegExp> = {
  ...
  [PIIType.PHONE]: /(\+966|00966|05)\d{8,9}|\b\d{10}\b|(\+?\d{1,3}[-.\s]?)?\(?\d{3}\)?[-.\s]?\d{3}[-.\s]?\d{4}\b/g,
  ...
  [PIIType.DATE_OF_BIRTH]: /\b(0?[1-9]|[12][0-9]|3[01])[\/\-](0?[1-9]|1[012])[\/\-](19|20)\d\d\b|\b(19|20)\d\d[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])\b/g,
  ...
  [PIIType.ADDRESS]: /\d+\s+[A-Za-z\s]+(?:Street|St|Avenue|Ave|Road|Rd|Boulevard|Blvd|Lane|Ln|Drive|Dr)/gi,
};
