...
describe("Permissions", () => {
  ...
  describe("roleHasPermission", () => {
    it("should return true when role has the permission", () => {
      expect(roleHasPermission(ROLES.FARMER, PERMISSIONS.FIELD_VIEW)).toBe(
        true,
      );
    ...
    it("should return false when role lacks the permission", () => {
      expect(roleHasPermission(ROLES.FARMER, PERMISSIONS.FIELD_DELETE)).toBe(
        false,
      );
      expect(roleHasPermission(ROLES.FARMER, PERMISSIONS.SYSTEM_ADMIN)).toBe(
        false,
      );
    });
  });
