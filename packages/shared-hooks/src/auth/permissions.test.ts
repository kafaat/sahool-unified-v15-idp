...
describe('Permissions', () => {
  ...
  describe('hasAnyPermission', () => {
    it('should return true when user has any of the permissions', () => {
      const roles: Role[] = [ROLES.FARMER];
      expect(hasAnyPermission(roles, [PERMISSIONS.FIELD_VIEW, PERMISSIONS.FIELD_DELETE])).toBe(
        true
      );
    });
    ...
    it('should return false when user has none of the permissions', () => {
      const roles: Role[] = [ROLES.FARMER];
      expect(hasAnyPermission(roles, [PERMISSIONS.FIELD_DELETE, PERMISSIONS.SYSTEM_ADMIN])).toBe(
        false
      );
    });
  ...
  describe('hasAllPermissions', () => {
    ...
    it('should return false when user is missing any permission', () => {
      const roles: Role[] = [ROLES.FARMER];
      expect(hasAllPermissions(roles, [PERMISSIONS.FIELD_VIEW, PERMISSIONS.FIELD_DELETE])).toBe(
        false
      );
    });
