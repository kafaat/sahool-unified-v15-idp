#!/usr/bin/env python3
"""Generate widget tests for the current SAHOOL Low-Code form PoC."""
...
DEFAULT_OUTPUT = (
    ...
    / "lowcode"
    / "generated"
    / "analyzesatellitegeometry_form_test.dart"
)
...
def main() -> int:
    ...
    args.output.write_text(generate_test(), encoding="utf-8")
