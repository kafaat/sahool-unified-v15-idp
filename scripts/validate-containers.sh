...
if grep -q 'ndkVersion = "28\.2\.13676358"' apps/mobile/android/app/build.gradle.kts; then
    check_pass "Mobile Android NDK version updated to 28.2.13676358"
else
    check_fail "Mobile Android NDK should be 28.2.13676358 for plugin compatibility"
fi
