...
_register(
    AgrovocConcept(
        uri="c_5744",
        pref_label_en="Phoenix dactylifera",
        pref_label_ar="نخيل التمر",
...
_register(
    AgrovocConcept(
        uri="c_4993",
        pref_label_en="Lycopersicon esculentum",
        pref_label_ar="طماطم",
...
_register(
    AgrovocConcept(
        uri="c_6980",
        pref_label_en="Sorghum bicolor",
        pref_label_ar="ذرة رفيعة",
...
_register(
    AgrovocConcept(
        uri="c_4829",
        pref_label_en="Coffea arabica",
        pref_label_ar="بن عربي",
...
_register(
    AgrovocConcept(
        uri="c_12332",
        pref_label_en="Zea mays",
        pref_label_ar="ذرة شامية",
...
_register(
    AgrovocConcept(
        uri="c_4986",
        pref_label_en="Medicago sativa",
        pref_label_ar="برسيم حجازي",
...
_register(
    AgrovocConcept(
        uri="c_6151",
        pref_label_en="Solanum tuberosum",
        pref_label_ar="بطاطس",
...
_register(
    AgrovocConcept(
        uri="c_4964",
        pref_label_en="Mangifera indica",
        pref_label_ar="مانجو",
        alt_labels_en=["mango"],
        alt_labels_ar=["منجا"],
        domain=AgrovocDomain.CROPS,
...
_register(
    AgrovocConcept(
        uri="c_1631",
        pref_label_en="Citrus",
        pref_label_ar="حمضيات",
...
_register(
    AgrovocConcept(
        uri="c_6762",
        pref_label_en="Rhynchophorus ferrugineus",
        pref_label_ar="سوسة النخيل الحمراء",
...
_register(
    AgrovocConcept(
        uri="c_25954",
        pref_label_en="Fusarium",
        pref_label_ar="فيوزاريوم",
...
_register(
    AgrovocConcept(
        uri="c_331",
        pref_label_en="Schistocerca gregaria",
        pref_label_ar="جراد صحراوي",
...
_register(
    AgrovocConcept(
        uri="c_773",
        pref_label_en="Bemisia tabaci",
        pref_label_ar="ذبابة بيضاء",
...
_register(
    AgrovocConcept(
        uri="c_7156",
        pref_label_en="sandy soil",
        pref_label_ar="تربة رملية",
...
_register(
    AgrovocConcept(
        uri="c_1640",
        pref_label_en="clay soil",
        pref_label_ar="تربة طينية",
        alt_labels_en=["clay"],
        alt_labels_ar=["طين"],
        domain=AgrovocDomain.SOIL,
    )
...
_register(
    AgrovocConcept(
        uri="c_7153",
        pref_label_en="soil salinity",
        pref_label_ar="ملوحة التربة",
...
_register(
    AgrovocConcept(
        uri="c_6213",
        pref_label_en="soil pH",
        pref_label_ar="حموضة التربة",
...
_register(
    AgrovocConcept(
        uri="c_3954",
        pref_label_en="drip irrigation",
        pref_label_ar="ري بالتنقيط",
...
_register(
    AgrovocConcept(
        uri="c_7186",
        pref_label_en="sprinkler irrigation",
        pref_label_ar="ري بالرش",
...
_register(
    AgrovocConcept(
        uri="c_2873",
        pref_label_en="evapotranspiration",
        pref_label_ar="التبخر-نتح",
...
_register(
    AgrovocConcept(
        uri="c_2432",
        pref_label_en="deficit irrigation",
        pref_label_ar="ري ناقص",
...
_register(
    AgrovocConcept(
        uri="c_5027",
        pref_label_en="nitrogen fertilizer",
        pref_label_ar="سماد نيتروجيني",
...
_register(
    AgrovocConcept(
        uri="c_5973",
        pref_label_en="phosphorus fertilizer",
        pref_label_ar="سماد فوسفاتي",
...
_register(
    AgrovocConcept(
        uri="c_6161",
        pref_label_en="potassium fertilizer",
        pref_label_ar="سماد بوتاسي",
...
_register(
    AgrovocConcept(
        uri="c_5296",
        pref_label_en="NPK fertilizer",
        pref_label_ar="سماد مركب NPK",
...
_register(
    AgrovocConcept(
        uri="c_5413",
        pref_label_en="organic fertilizer",
        pref_label_ar="سماد عضوي",
...
_register(
    AgrovocConcept(
        uri="c_1665",
        pref_label_en="arid climate",
        pref_label_ar="مناخ جاف",
...
_register(
    AgrovocConcept(
        uri="c_49896",
        pref_label_en="unmanned aerial vehicle",
        pref_label_ar="طائرة بدون طيار",
...
_register(
    AgrovocConcept(
        uri="c_24896",
        pref_label_en="precision agriculture",
        pref_label_ar="زراعة دقيقة",
...
_register(
    AgrovocConcept(
        uri="c_5354",
        pref_label_en="Abelmoschus esculentus",
        pref_label_ar="بامية",
...
_register(
    AgrovocConcept(
        uri="c_1614",
        pref_label_en="Citrullus lanatus",
        pref_label_ar="بطيخ",
...
_register(
    AgrovocConcept(
        uri="c_5459",
        pref_label_en="Pennisetum glaucum",
        pref_label_ar="دخن",
...
_register(
    AgrovocConcept(
        uri="c_7811",
        pref_label_en="Solanum melongena",
        pref_label_ar="باذنجان",
...
_register(
    AgrovocConcept(
        uri="c_8061",
        pref_label_en="Trigonella foenum-graecum",
        pref_label_ar="حلبة",
...
_register(
    AgrovocConcept(
        uri="c_25955",
        pref_label_en="Septoria tritici",
        pref_label_ar="سبتوريا القمح",
...
_register(
    AgrovocConcept(
        uri="c_8098",
        pref_label_en="Tuta absoluta",
        pref_label_ar="توتا أبسلوتا",
...
_register(
    AgrovocConcept(
        uri="c_25111",
        pref_label_en="Dubas bug",
        pref_label_ar="حشرة الدوباس",
...
_register(
    AgrovocConcept(
        uri="c_7717",
        pref_label_en="Spodoptera",
        pref_label_ar="دودة ورق القطن",
...
_register(
    AgrovocConcept(
        uri="c_25950",
        pref_label_en="Bayoud disease",
        pref_label_ar="مرض البيوض",
...
_register(
    AgrovocConcept(
        uri="c_4876",
        pref_label_en="Meloidogyne",
        pref_label_ar="نيماتودا تعقد الجذور",
...
_register(
    AgrovocConcept(
        uri="c_25960",
        pref_label_en="Eurygaster integriceps",
        pref_label_ar="حشرة السونة",
...
_register(
    AgrovocConcept(
        uri="c_25970",
        pref_label_en="water harvesting",
        pref_label_ar="حصاد مياه",
...
_register(
    AgrovocConcept(
        uri="c_3338",
        pref_label_en="flood irrigation",
        pref_label_ar="ري غمر",
...
_register(
    AgrovocConcept(
        uri="c_25971",
        pref_label_en="center pivot irrigation",
        pref_label_ar="ري محوري",
...
_register(
    AgrovocConcept(
        uri="c_7157",
        pref_label_en="soil moisture",
        pref_label_ar="رطوبة التربة",
...
_register(
    AgrovocConcept(
        uri="c_1436",
        pref_label_en="Camelus dromedarius",
        pref_label_ar="جمل عربي",
...
_register(
    AgrovocConcept(
        uri="c_25980",
        pref_label_en="NDVI",
        pref_label_ar="مؤشر الغطاء النباتي",
...
_register(
    AgrovocConcept(
        uri="c_25981",
        pref_label_en="leaf area index",
        pref_label_ar="مؤشر مساحة الورقة",
        alt_labels_en=["LAI"],
        alt_labels_ar=["م.م.و"],
        domain=AgrovocDomain.CLIMATE,
    )
...
_register(
    AgrovocConcept(
        uri="c_25990",
        pref_label_en="humic acid",
        pref_label_ar="حمض الهيوميك",
...
_register(
    AgrovocConcept(
        uri="c_25991",
        pref_label_en="micronutrients",
        pref_label_ar="عناصر صغرى",
...
_register(
    AgrovocConcept(
        uri="c_26001",
        pref_label_en="variable rate application",
        pref_label_ar="استخدام معدل متغير",
...
_register(
    AgrovocConcept(
        uri="c_26002",
        pref_label_en="GPS guidance",
        pref_label_ar="توجيه GPS",
...
_register(
    AgrovocConcept(
        uri="c_26003",
        pref_label_en="yield mapping",
        pref_label_ar="خرائط الإنتاجية",
...
_register(
    AgrovocConcept(
        uri="c_26004",
        pref_label_en="precision seeding",
        pref_label_ar="بذر دقيق",
...
_register(
    AgrovocConcept(
        uri="c_26005",
        pref_label_en="soil sampling",
        pref_label_ar="أخذ عينات التربة",
...
_register(
    AgrovocConcept(
        uri="c_26010",
        pref_label_en="cyber-physical system",
        pref_label_ar="نظام سيبراني-فيزيائي",
...
_register(
    AgrovocConcept(
        uri="c_26011",
        pref_label_en="simulation model",
        pref_label_ar="نموذج محاكاة",
...
_register(
    AgrovocConcept(
        uri="c_26012",
        pref_label_en="real-time monitoring",
        pref_label_ar="مراقبة آنية",
...
_register(
    AgrovocConcept(
        uri="c_26020",
        pref_label_en="synthetic aperture radar",
        pref_label_ar="رادار الفتحة الاصطناعية",
...
_register(
    AgrovocConcept(
        uri="c_26021",
        pref_label_en="thermal imaging",
        pref_label_ar="تصوير حراري",
...
_register(
    AgrovocConcept(
        uri="c_26022",
        pref_label_en="hyperspectral imaging",
        pref_label_ar="تصوير فوق طيفي",
...
_register(
    AgrovocConcept(
        uri="c_26030",
        pref_label_en="good agricultural practices",
        pref_label_ar="الممارسات الزراعية الجيدة",
...
_register(
    AgrovocConcept(
        uri="c_26031",
        pref_label_en="integrated pest management",
        pref_label_ar="إدارة آفات متكاملة",
...
_register(
    AgrovocConcept(
        uri="c_26032",
        pref_label_en="conservation agriculture",
        pref_label_ar="زراعة محافظة",
