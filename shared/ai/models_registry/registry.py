...
class AgriculturalAIRegistry:
    ...
    def _load_breeding_bioscience_models(self) -> None:
        ...
        self._register(AIModelInfo(
            ...
            use_cases=["Gene function analysis", "Breeding recommendations", "Phenotype prediction"],
    ...
    def _load_livestock_veterinary_models(self) -> None:
        ...
        self._register(AIModelInfo(
            ...
            use_cases=["Milk production optimization", "Dairy cattle health", "Feed management"],
    ...
    def discover_open_source(self) -> ModelDiscoveryResult:
        ...
        models = [
            ...
            if m.license == ModelLicense.OPEN_SOURCE
        ]
    ...
    def search(
        ...
        if country and any(m.developer for m in models):
            models = [
                m for m in models
                if m.developer and m.developer.country.lower() == country.lower()
            ]
        ...
        if query:
            ...
            models = [
                ...
                if (
                    ...
                    query_lower in m.name_cn.lower() or
                    query_lower in m.name_ar.lower() or
    ...
    def get_statistics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "open_source_count": sum(
                1 for m in models if m.license == ModelLicense.OPEN_SOURCE
            ),
