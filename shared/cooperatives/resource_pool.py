...
class ResourcePoolService:
    ...
    async def complete_booking(
        ...
        resource.last_used_date = datetime.utcnow()
    ...
    async def find_available_slot(
        ...
        """
        start_date = preferred_date or datetime.utcnow()
    ...
    async def get_pool_summary(self) -> dict[str, Any]:
        ...
        upcoming_bookings = sorted(
            [b for b in pending_bookings if b.start_time > datetime.utcnow()],
        ...
        return {
            ...
            "utilization_summary": {
                "total_hours_this_month": sum(
                    ...
                    and b.start_time >= datetime(datetime.utcnow().year, datetime.utcnow().month, 1)
                ),
            },
        }
...
async def create_resource_pool(cooperative_id: str) -> ResourcePoolService:
    """Create a new resource pool service"""
    return ResourcePoolService(cooperative_id=cooperative_id)
