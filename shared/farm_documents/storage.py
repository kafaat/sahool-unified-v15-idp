...
class DocumentStorageService:
    ...
    async def upload_document(
        ...
        if self.config.compute_checksums:
            ...
            md5_hash = hashlib.md5(file_content, usedforsecurity=False).hexdigest()  # nosemgrep: python.lang.security.audit.insecure-hash-algorithm-md5 -- backward compatibility checksum, not for security
