...
class ServerConfig:
    ...
    version: str = "1.0.0"
    host: str = field(default_factory=lambda: os.getenv("MCP_HOST", "0.0.0.0"))  # nosec B104 - default for containerized deployment, overridden by env  # noqa: S104  # nosec B104
