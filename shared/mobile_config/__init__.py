...
MOBILE_IMPROVEMENTS: list[dict] = [
    ...
    {
        "id": "MOB-02",
        "title": "Auto Image Compression",
        "title_ar": "ضغط الصور التلقائي",
    ...
    },
    {
        ...
        "title_ar": "تقليل استهلاك البطارية",
        "description": "Optimize GPS polling + reduce background tasks",
        "description_ar": "تحسين GPS polling + تقليل المهام الخلفية",
        "category": ImprovementCategory.PERFORMANCE,
        "priority": Priority.P1,
        "effort_weeks": 1,
        "reference": "Android/iOS guidelines",
        "status": ImprovementStatus.PLANNED,
    },
    # === ux (4) | واجهة المستخدم ===
    {
        "id": "MOB-05",
        "title": "Simplified Home Screen",
        "title_ar": "واجهة مبسطة للصفحة الرئيسية",
    ...
    },
    {
        ...
        "priority": Priority.P0,
        "effort_weeks": 1,
        "reference": "AgTech best practices",
        "status": ImprovementStatus.PLANNED,
    },
    {
        "id": "MOB-07",
        "title": "Agricultural Icons",
        "title_ar": "أيقونات زراعية محلية",
    ...
    {
        "id": "MOB-10",
        "title": "Offline Advisory Cache",
        "title_ar": "تخزين مؤقت للنصائح",
    ...
    # === security (4) | الأمان ===
    {
        ...
        "priority": Priority.P0,
        "effort_weeks": 1,
        "reference": "local_auth",
        "status": ImprovementStatus.COMPLETED,
    },
    {
        "id": "MOB-14",
        "title": "Certificate Pinning",
        "title_ar": "تثبيت الشهادات",
    ...
    {
        "id": "MOB-20",
        "title": "Harvest Photo Report",
        "title_ar": "تقرير حصاد مصوّر",
