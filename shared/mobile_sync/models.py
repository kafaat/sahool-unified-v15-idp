...
SYNC_MESSAGES = {
    "sync_started": BilingualMessage(
        en="Synchronization started",
        ar="بدأت المزامنة"
    ),
    "sync_completed": BilingualMessage(
        en="Synchronization completed successfully",
        ar="اكتملت المزامنة بنجاح"
    ),
    "sync_failed": BilingualMessage(
        en="Synchronization failed",
        ar="فشلت المزامنة"
    ),
    "sync_partial": BilingualMessage(
        en="Synchronization partially completed",
        ar="اكتملت المزامنة جزئياً"
    ),
    "conflict_detected": BilingualMessage(
        en="Conflict detected, manual resolution required",
        ar="تم اكتشاف تعارض، يلزم حل يدوي"
    ),
    "conflict_resolved": BilingualMessage(
        en="Conflict resolved successfully",
        ar="تم حل التعارض بنجاح"
    ),
    ...
    "queued_for_sync": BilingualMessage(
        en="Changes queued for synchronization",
        ar="التغييرات في قائمة انتظار المزامنة"
    ),
    "upload_completed": BilingualMessage(
        en="Upload completed",
        ar="اكتمل الرفع"
    ),
    "download_completed": BilingualMessage(
        en="Download completed",
        ar="اكتمل التنزيل"
    ),
    "delta_sync_available": BilingualMessage(
        en="Incremental sync available",
        ar="المزامنة التزايدية متاحة"
    ),
    "full_sync_required": BilingualMessage(
        en="Full sync required",
        ar="يلزم مزامنة كاملة"
    ),
}
...
SYNC_ERRORS = {
    "network_error": BilingualMessage(
        en="Network error occurred during sync",
        ar="حدث خطأ في الشبكة أثناء المزامنة"
    ),
    "server_error": BilingualMessage(
        en="Server error occurred",
        ar="حدث خطأ في الخادم"
    ),
    "timeout_error": BilingualMessage(
        en="Sync operation timed out",
        ar="انتهت مهلة عملية المزامنة"
    ),
    ...
    "quota_exceeded": BilingualMessage(
        en="Sync quota exceeded",
        ar="تم تجاوز حصة المزامنة"
    ),
    "version_mismatch": BilingualMessage(
        en="Data version mismatch",
        ar="عدم تطابق إصدار البيانات"
    ),
    "conflict_unresolved": BilingualMessage(
        en="Unresolved conflict exists",
        ar="يوجد تعارض لم يُحل"
    ),
    "storage_full": BilingualMessage(
        en="Local storage is full",
        ar="التخزين المحلي ممتلئ"
    ),
    "invalid_entity": BilingualMessage(
        en="Invalid entity for sync",
        ar="كيان غير صالح للمزامنة"
    ),
}
