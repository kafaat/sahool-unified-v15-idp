...
class SecretManager:
    ...
    def _get_from_vault(self, key: str) -> str | None:
        ...
        try:
            ...
            logger.warning("Failed to read secret from Vault: %s", type(e).__name__)  # nosemgrep: python-logger-credential-disclosure -- logs exception type name, not credentials
    ...
    def set_secret(self, key: str, value: str) -> bool:
        ...
        try:
            ...
            logger.error("Failed to write secret to Vault: %s", type(e).__name__)  # nosemgrep: python-logger-credential-disclosure -- logs exception type name, not credentials
