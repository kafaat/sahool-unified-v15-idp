...
async def batch_insert(
    ...
    for batch_idx in range(num_batches):
        ...
        sql = f"INSERT INTO {quoted_table} ({', '.join(quoted_columns)}) VALUES {batch_placeholders}"  # noqa: S608  # nosec B608 - table/columns are quoted via _quote_identifier; values use $N params
