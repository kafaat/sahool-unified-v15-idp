...
YEMEN_CROPS: dict[str, YemenCropParameters] = {
    ...
    "sorghum": YemenCropParameters(
        ...
        regions=["tihama", "eastern_plateau", "highlands"],
    ...
    "date_palm": YemenCropParameters(
        ...
        regions=["hadhramaut", "tihama", "eastern_plateau"],
    ...
    "tomato": YemenCropParameters(
        ...
        regions=["highlands", "tihama", "hadhramaut"],
    ...
    "sesame": YemenCropParameters(
        ...
        growth_stages=[
            ...
            GrowthStage("Late", "المرحلة المتأخرة", 20, 0.50, 1000),
        ],
    ...
    "onion": YemenCropParameters(
        ...
        salinity_slope=16.0,
        growth_stages=[
            GrowthStage("Initial", "المرحلة الأولية", 20, 0.50, 80),
            GrowthStage("Development", "مرحلة النمو", 30, 0.70, 300),
            GrowthStage("Mid-season", "منتصف الموسم", 50, 1.00, 700),
