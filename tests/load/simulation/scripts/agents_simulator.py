        ...
        return await self.request(
            ...
            json={
                ...
                "symptoms": {
                    ...
                    "affected_parts": random.sample(
                        ["leaves", "stems", "roots", "fruits", "flowers"], random.randint(1, 3)
                    ),
                },
...
def main():
    parser = argparse.ArgumentParser(description="SAHOOL IDP - AI Agents Simulator")
    parser.add_argument(
        "--gateway",
        "-g",
